    ...
    <div class="content">
        <div class="row">
            @isset($item)
                ...
                <form class="form-horizontal push-30-t push-30" action="{{ route('itemsglobalglobal.destroy', [request()->route('profile'), $item]) }}" method="post" >
                    {{ method_field('DELETE') }}
                    {{ csrf_field() }}
            ...
            <div class="block-content block-content-full">
                <div class="row">
                    <div class="col-sm-8 col-sm-offset-2 col-lg-6 col-lg-offset-3">
                        @isset($item)
                            <form class="form-horizontal push-30-t push-30" action="{{ route('itemsglobal.update', [request()->route('profile'), $item]) }}" method="post" enctype="multipart/form-data">
                                {{ method_field('PUT') }}
                            @else
                                <form class="form-horizontal push-30-t push-30" action="{{ route('itemsglobal.store', request()->route('profile')) }}" method="post" enctype="multipart/form-data">
                                @endif
                                {{ csrf_field() }}
                                <div class="form-group">
                                    <div class="col-xs-12">
                                        <div class="form-material form-material-primary">
                                            <router-view name="SearchBoxItem"   :current_company="{{request()->route('profile')}}" >
