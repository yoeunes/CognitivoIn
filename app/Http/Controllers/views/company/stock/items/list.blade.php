  ...
  <div class="content">
    <div class="row">
      <div class="col-sm-6 col-md-3">
        <a class="block block-link-hover3 text-center" href="{{ route('items.create', request()->route('profile')) }}">
            ...
            @foreach ($items as $item)
              ...
              <tr>
                ...
                <td class="text-center">
                  <a class="font-" href="{{ route('items.edit',[ request()->route('profile'),$item]) }}">
                    <strong>{{$item->sku}}</strong>
                  </a>
                </td>
                <td class="visible-lg">
                  <a href="{{ route('items.edit',[ request()->route('profile'),$item]) }}">{{$item->name}}</a>
                </td>
