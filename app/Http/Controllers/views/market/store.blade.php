        ...
        <div class="bg-primary-dark-op">
            <section class="content content-full content-boxed overflow-hidden">
                ...
                <div class="push-30-t push-30 text-center">
                    <h1 class="h2 text-white push-10 animated fadeInDown" data-toggle="appear" data-class="animated fadeInDown">Welcome to our Digital Store!</h1>
                    <h2 class="h5 text-white-op animated fadeInDown" data-toggle="appear" data-class="animated fadeInDown">Feel free to explore.</h2>
                </div>
                <!-- END Section Content -->
            </section>
        </div>
    ...
    <section class="content content-boxed">
        ...
        <div class="row">
            <div class="col-sm-6 col-lg-3">
                <div class="block">
                    <div class="img-container">
                        <img class="img-responsive" src="/img/various/ecom_product1.png" alt="">
                    ...
                    <div class="block-content">
                        <div class="push-10">
                            ...
                            <a class="h4" href="base_pages_ecom_store_product.html">Iconic</a>
                        </div>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="block">
                    <div class="img-container">
                        <img class="img-responsive" src="/img/various/ecom_product2.png" alt="">
                        <div class="img-options">
                            <div class="img-options-content">
                                <div class="push-20">
                                    <a class="btn btn-sm btn-default" href="base_pages_ecom_store_product.html">View</a>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="block">
                    <div class="img-container">
                        <img class="img-responsive" src="/img/various/ecom_product3.png" alt="">
                        <div class="img-options">
                            <div class="img-options-content">
                                <div class="push-20">
                                    <a class="btn btn-sm btn-default" href="base_pages_ecom_store_product.html">View</a>
                    ...
                    <div class="block-content">
                        <div class="push-10">
                            ...
                            <a class="h4" href="base_pages_ecom_store_product.html">Office Suite</a>
                        </div>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="block">
                    <div class="img-container">
                        <img class="img-responsive" src="/img/various/ecom_product4.png" alt="">
                        <div class="img-options">
                            <div class="img-options-content">
                                <div class="push-20">
                                    <a class="btn btn-sm btn-default" href="base_pages_ecom_store_product.html">View</a>
            ...
            <div class="col-xs-12 text-right push">
                <a class="font-w600 link-effect" href="base_pages_ecom_store_products.html">View More New Arrivals <i class="fa fa-angle-right"></i></a>
            </div>
        </div>
        <!-- END New Arrivals -->
        ...
        <div class="row">
            <div class="col-sm-6 col-lg-3">
                <div class="block">
                    <div class="img-container">
                        <img class="img-responsive" src="/img/various/ecom_product5.png" alt="">
                        <div class="img-options">
                            <div class="img-options-content">
                                <div class="push-20">
                                    <a class="btn btn-sm btn-default" href="base_pages_ecom_store_product.html">View</a>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="block">
                    <div class="img-container">
                        <img class="img-responsive" src="/img/various/ecom_product6.png" alt="">
                        <div class="img-options">
                            <div class="img-options-content">
                                <div class="push-20">
                                    <a class="btn btn-sm btn-default" href="base_pages_ecom_store_product.html">View</a>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="block">
                    <div class="img-container">
                        <img class="img-responsive" src="/img/various/ecom_product7.png" alt="">
                        <div class="img-options">
                            <div class="img-options-content">
                                <div class="push-20">
                                    <a class="btn btn-sm btn-default" href="base_pages_ecom_store_product.html">View</a>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="block">
                    <div class="img-container">
                        <img class="img-responsive" src="/img/various/ecom_product8.png" alt="">
                        <div class="img-options">
                            <div class="img-options-content">
                                <div class="push-20">
                                    <a class="btn btn-sm btn-default" href="base_pages_ecom_store_product.html">View</a>
        ...
        <div class="row">
            <div class="col-sm-6 col-lg-3">
                <div class="block">
                    <div class="img-container">
                        <img class="img-responsive" src="/img/various/ecom_product9.png" alt="">
                        <div class="img-options">
                            <div class="img-options-content">
                                <div class="push-20">
                                    <a class="btn btn-sm btn-default" href="base_pages_ecom_store_product.html">View</a>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="block">
                    <div class="img-container">
                        <img class="img-responsive" src="/img/various/ecom_product10.png" alt="">
                        <div class="img-options">
                            <div class="img-options-content">
                                <div class="push-20">
                                    <a class="btn btn-sm btn-default" href="base_pages_ecom_store_product.html">View</a>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="block">
                    <div class="img-container">
                        <img class="img-responsive" src="/img/various/ecom_product11.png" alt="">
                        <div class="img-options">
                            <div class="img-options-content">
                                <div class="push-20">
                                    <a class="btn btn-sm btn-default" href="base_pages_ecom_store_product.html">View</a>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="block">
                    <div class="img-container">
                        <img class="img-responsive" src="/img/various/ecom_product12.png" alt="">
                        <div class="img-options">
                            <div class="img-options-content">
                                <div class="push-20">
                                    <a class="btn btn-sm btn-default" href="base_pages_ecom_store_product.html">View</a>
    ...
    <div class="bg-gray-light border-t border-b">
        <section class="content content-full content-boxed">
            ...
            <div class="push-20-t push-20 text-center">
                <h3 class="h4 push-20 animated fadeIn" data-toggle="appear">Over <strong>50.000</strong> digital products!</h3>
                <a class="btn btn-rounded btn-noborder btn-lg btn-success animated bounceIn" data-toggle="appear" data-class="animated bounceIn" href="base_pages_ecom_store_products.html">Explore Store <i class="fa fa-arrow-right"></i></a>
            </div>
            <!-- END Section Content -->
        </section>
    </div>
