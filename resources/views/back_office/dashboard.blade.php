<main id="main-container" style="min-height: 268px;">
    <!-- Page Content -->
    <div class="content">
            ...
            <div class="col-md-6">
                <div class="block">
                    ...
                    <div class="block-content block-content-full">
                        <div class="pull-all"><div class="chartjs-size-monitor" style="position: absolute; left: 0px; top: 0px; right: 0px; bottom: 0px; overflow: hidden; pointer-events: none; visibility: hidden; z-index: -1;">
                        ...
                        <canvas class="js-chartjs-dashboard-lines chartjs-render-monitor" width="1146" height="572" style="display: block; height: 286px; width: 573px;"></canvas>
                    </div>
                </div>
        ...
        <div class="col-md-6">
            <div class="block">
                ...
                <div class="block-content block-content-full">
                    <div class="pull-all"><div class="chartjs-size-monitor" style="position: absolute; left: 0px; top: 0px; right: 0px; bottom: 0px; overflow: hidden; pointer-events: none; visibility: hidden; z-index: -1;"><div class="chartjs-size-monitor-expand" style="position:absolute;left:0;top:0;right:0;bottom:0;overflow:hidden;pointer-events:none;visibility:hidden;z-index:-1;"><div style="position:absolute;width:1000000px;height:1000000px;left:0;top:0"></div></div><div class="chartjs-size-monitor-shrink" style="position:absolute;left:0;top:0;right:0;bottom:0;overflow:hidden;pointer-events:none;visibility:hidden;z-index:-1;"><div style="position:absolute;width:200%;height:200%;left:0; top:0"></div></div></div>
                    <!-- Lines Chart Container -->
                    <canvas class="js-chartjs-dashboard-lines2 chartjs-render-monitor" width="1146" height="572" style="display: block; height: 286px; width: 573px;"></canvas>
                </div>
            </div>
...
<div class="row gutters-tiny invisible js-appear-enabled" data-toggle="appear">
    <!-- Row #4 -->
    <div class="col-md-6">
