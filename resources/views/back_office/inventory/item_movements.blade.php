...
<div class="content">
    ...
    <!-- Overview -->
    <h2 class="content-heading">Stock | <b>Product Movements</b></h2>
            ...
            <a class="block block-rounded block-link-shadow" @click="onCreate()" href="#">
                <div class="block-content block-content-full block-sticky-options">
                    ...
                    <div class="py-20 text-center">
                        ...
                        <div class="font-size-sm font-w600 text-uppercase text-muted">New Movement</div>
                    </div>
                </div>
            </a>
        </div>
    ...
    <div class="block block-fx-shadow">
        <div class="block-content">
            <div v-if="showList">
                @include('back_office/inventory/item_movements/list')
            </div>
            <div v-else>
                @include('back_office/inventory/item_movements/form')
            </div>
        </div>
    </div>
</div>
