<account-receivable-form ref="back_officeForm" inline-template>
    <div>
        <div class="content">
            <div class="block block-fx-shadow">
                <div class="block-content">
                    <!-- User Profile -->
                    <h2 class="content-heading text-black"> Item Movement </h2>
                    ...
                    <!-- Personal Details -->
                    <h2 class="content-heading text-black">Detail</h2>
                    <div class="row items-push">
                        <div class="col-lg-3">
                            <p class="text-muted">
