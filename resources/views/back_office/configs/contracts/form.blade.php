<contract-form profile="{{ request()->route('profile')->slug }}" inline-template>
    <div>
        ...
        <div class="row" v-if="showDetail">
            ...
            <div class="col-5">
                <p class="m--font-boldest m--font-transform-u">@lang('global.contract')</p>
            </div>
            <div class="col-5">
                <p class="m--font-boldest m--font-transform-u">@lang('global.percent')</p>
            </div>
            <div class="row m--margin-bottom-5" v-for="detail in contractdetails">
            ...
            <div class="form-group">
                <div class="col-xs-12">
                    <div class="form-material form-material-primary">
                        <input class="form-control" type="text" v-model="offset">

                        <label for="product-name">Offset</label>
                    </div>
                </div>
            </div>
            <div class="form-group">
