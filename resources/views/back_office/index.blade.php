                ...
                <header id="page-header">
                    ...
                    <div class="content-header">
                        ...
                        <div class="content-header-section">
                            ...
                            {{--
                            <div class="dropdown-menu dropdown-menu-right min-width-150 show" aria-labelledby="page-header-user-dropdown" x-placement="bottom-end" style="position: absolute; transform: translate3d(-52px, 34px, 0px); top: 0px; left: 0px; will-change: transform;">
                            --}}
