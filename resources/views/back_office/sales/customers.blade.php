...
<div class="content">
    ...
    <!-- Overview -->
    <h2 class="content-heading">@lang('back-office.Sales') | <b>@lang('back-office.Customers')</b></h2>
            ...
            <div class="block block-rounded block-link-shadow">
                <div class="block-content block-content-full block-sticky-options">
                    <div class="py-20 text-center">
                        ...
                        <div class="font-size-sm font-w600 text-uppercase text-muted">@lang('back-office.Customers')</div>
                    </div>
                </div>
            </div>
        </div>
