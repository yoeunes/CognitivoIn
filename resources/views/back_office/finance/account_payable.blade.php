...
<div class="content">
            ...
            <a class="block block-rounded block-link-shadow" @click="onCreate()" href="#" v-if="showList">
                <div class="block-content block-content-full block-sticky-options">
                    ...
                    <div class="py-20 text-center">
                        ...
                        <div class="font-size-sm font-w600 text-uppercase text-muted">Make a Payment</div>
                    </div>
                </div>
            </a>
        </div>
    ...
    <div class="block block-fx-shadow">
        <div class="block-content">
            <div v-if="showList">
                @include('back_office/finance/account_payables/list')
            </div>
            <div v-else>
                @include('back_office/finance/account_payables/form')
            </div>
        </div>
    </div>
</div>
