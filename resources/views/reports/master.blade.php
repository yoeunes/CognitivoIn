    ...
    <div class="container">
        <div class="row">
            <table class="u-full-width">
                <tr>
                    <td style="text-align:right">@lang('global.Company')</td>
    ...
    <div class="row">
        <table class="u-full-width">
            <tr>
                ...
                <td style="text-align:right">@lang('global.User') <b>{{ Auth::user()->name }}</b> | <a href="mailto:{{ Auth::user()->email }}">{{ Auth::user()->email }}</a></td>
            </tr>
        </table>
    </div>
    @yield('script')
