            ...
            <div>
                ...
                <div class="row items-push">
                    ...
                    <div class="col-lg-7 offset-lg-1">
                        ...
                        <b-field v-bind:label="lang('back-office.Name')">
                            <b-input v-model="customer_alias"></b-input>
                        </b-field>

                        <b-field v-bind:label="lang('global.TaxID')">
                            <b-input v-model="customer_taxid"></b-input>
                        </b-field>

                        <b-field v-bind:label="lang('back-office.CreditLimit')">
                            <b-input v-model="credit_limit" type="number"></b-input>
                        </b-field>

                        <b-field v-bind:label="lang('global.Contract')" v-if="credit_limit != ''">
                ...
                <div class="row items-push">
                    ...
                    <div class="col-lg-7 offset-lg-1">
                        <b-field v-bind:label="lang('global.Telephone')">
                            <b-input v-model="customer_telephone"></b-input>
                        </b-field>
                        <b-field v-bind:label="lang('global.Email')">
                            <b-input v-model="customer_email" type="email"></b-input>
                        </b-field>
                        <b-field v-bind:label="lang('global.Address')">
