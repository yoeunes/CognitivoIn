    ...
    <relationship-form ref="back_officeForm" inline-template>
      <div>
        ...
        <div class="row items-push">
          <div class="col-lg-3">
            <p class="text-muted">
              Load the suppliers commercial information, this information helps during order process.
            </p>
          </div>
...
export default {
  ...
  methods: {
    ...
    {
      var app = this;
      axios.post('/api/' + app.profile + '/back-office/suppliers', $data)
      .then(() =>
      {
        this.$toast.open({
  ...
  mounted: function mounted()
  {
    ...
    if (app.id>0) {
      ...
      axios.get('/api/' + app.profile + '/back-office/suppliers/' + app.id + '/edit')
