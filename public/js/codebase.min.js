...
! function(e, t) {
    ...
    function l(e) {
        var t = {};
        return _e.each(e.match(Ne) || [], function(e, n) {
            t[n] = !0
        }), t
    }
    ...
    function f() {
        oe.removeEventListener("DOMContentLoaded", f), e.removeEventListener("load", f), _e.ready()
    }
    ...
    function p(e) {
        return e.replace(He, "ms-").replace(Pe, h)
    }
    ...
    function y(e, t, n, i) {
        var r, o, a = 20,
            ...
            u = (_e.cssNumber[t] || "px" !== c && +l) && Be.exec(_e.css(e, t));
        if (u && u[3] !== c) {
            for (l /= 2, c = c || u[3], u = +l || 1; a--;) _e.style(e, t, u + c), (1 - o) * (1 - (o = s() / l || .5)) <= 0 && (a = 0), u /= o;
    ...
    function b(e) {
        var t, n = e.ownerDocument,
            i = e.nodeName,
            r = Ye[i];
        return r || (t = n.body.appendChild(n.createElement(i)), r = _e.css(t, "display"), t.parentNode.removeChild(t), "none" === r && (r = "block"), Ye[i] = r, r)
    }

    function _(e, t) {
        for (var n, i, r = [], o = 0, a = e.length; o < a; o++)(i = e[o]).style && (n = i.style.display, t ? ("none" === n && (r[o] = Me.get(i, "display") || null, r[o] || (i.style.display = "")), "" === i.style.display && Ve(i) && (r[o] = b(i))) : "none" !== n && (r[o] = "none", Me.set(i, "display", n)));
    ...
    function E(e, t, n, r, o) {
        for (var a, s, l, c, u, d, f = t.createDocumentFragment(), h = [], p = 0, g = e.length; p < g; p++)
            if ((a = e[p]) || 0 === a)
                if ("object" === i(a)) _e.merge(h, a.nodeType ? [a] : a);
                else if (Je.test(a)) {
            for (s = s || f.appendChild(t.createElement("div")), l = (ze.exec(a) || ["", ""])[1].toLowerCase(), c = Xe[l] || Xe._default, s.innerHTML = c[1] + _e.htmlPrefilter(a) + c[2], d = c[0]; d--;) s = s.lastChild;
            _e.merge(h, s.childNodes), (s = f.firstChild).textContent = ""
        } else h.push(t.createTextNode(a));
        for (f.textContent = "", p = 0; a = h[p++];)
            if (r && _e.inArray(a, r) > -1) o && o.push(a);
            else if (u = _e.contains(a.ownerDocument, a), s = C(f.appendChild(a), "script"), u && w(s), n)
    ...
    function N(e, t) {
        ...
        if (1 === t.nodeType) {
            ...
            Re.hasData(e) && (s = Re.access(e), l = _e.extend({}, s), Re.set(t, l))
        }
    }
    ...
    function O(e, t, i, r) {
        ...
        var o, a, s, l, c, u, d = 0,
            ...
            p = t[0],
            g = ve(p);
        if (g || f > 1 && "string" == typeof p && !me.checkClone && ot.test(p)) return e.each(function(n) {
            var o = e.eq(n);
            g && (t[0] = p.call(this, n, o.html())), O(o, t, i, r)
        });
        if (f && (o = E(t, e[0].ownerDocument, !1, e, r), a = o.firstChild, 1 === o.childNodes.length && (o = a), a || r)) {
            for (l = (s = _e.map(C(o, "script"), A)).length; d < f; d++) c = o, d !== h && (c = _e.clone(c, !0, !0), l && _e.merge(s, C(c, "script"))), i.call(e[d], c, d);
            if (l)
                for (u = s[s.length - 1].ownerDocument, _e.map(s, D), d = 0; d < l; d++) c = s[d], Ge.test(c.type || "") && !Me.access(c, "globalEval") && _e.contains(u, c) && (c.src && "module" !== (c.type || "").toLowerCase() ? _e._evalUrl && _e._evalUrl(c.src) : n(c.textContent.replace(at, ""), u, c))
        }
        return e
    }

    function L(e, t, n) {
        for (var i, r = t ? _e.filter(t, e) : e, o = 0; null != (i = r[o]); o++) n || 1 !== i.nodeType || _e.cleanData(C(i)), i.parentNode && (n && _e.contains(i.ownerDocument, i) && w(C(i, "script")), i.parentNode.removeChild(i));
        return e
    }

    function H(e, t, n) {
        var i, r, o, a, s = e.style;
        return (n = n || lt(e)) && ("" !== (a = n.getPropertyValue(t) || n[t]) || _e.contains(e.ownerDocument, e) || (a = _e.style(e, t)), !me.pixelBoxStyles() && st.test(a) && ct.test(t) && (i = s.width, r = s.minWidth, o = s.maxWidth, s.minWidth = s.maxWidth = s.width = a, a = n.width, s.width = i, s.minWidth = r, s.maxWidth = o)), void 0 !== a ? a + "" : a
    }
    ...
    function F(e, t, n, i, r, o) {
        ...
        for (; a < 4; a += 2) "margin" === n && (l += _e.css(e, n + Ue[a], !0, r)), i ? ("content" === n && (l -= _e.css(e, "padding" + Ue[a], !0, r)), "margin" !== n && (l -= _e.css(e, "border" + Ue[a] + "Width", !0, r))) : (l += _e.css(e, "padding" + Ue[a], !0, r), "padding" !== n ? l += _e.css(e, "border" + Ue[a] + "Width", !0, r) : s += _e.css(e, "border" + Ue[a] + "Width", !0, r));
    ...
    function W(e, t, n) {
        ...
        return a = a && (me.boxSizingReliable() || r === e.style[t]), ("auto" === r || !parseFloat(r) && "inline" === _e.css(e, "display", !1, i)) && (r = e["offset" + t[0].toUpperCase() + t.slice(1)], a = !0), (r = parseFloat(r) || 0) + F(e, t, n || (o ? "border" : "content"), a, i, r) + "px"
    }
    ...
    function B() {
        vt && (!1 === oe.hidden && e.requestAnimationFrame ? e.requestAnimationFrame(B) : e.setTimeout(B, _e.fx.interval), _e.fx.tick())
    }
    ...
    function $(e, t, n) {
        for (var i, r = (K.tweeners[t] || []).concat(K.tweeners["*"]), o = 0, a = r.length; o < a; o++)
    ...
    function Y(e, t) {
        var n, i, r, o, a;
        for (n in e)
            if (i = p(n), r = t[i], o = e[n], Array.isArray(o) && (r = o[1], o = e[n] = o[0]), n !== i && (e[i] = o, delete e[n]), (a = _e.cssHooks[i]) && "expand" in a) {
    ...
    function K(e, t, n) {
        var i, r, o = 0,
            ...
            l = function() {
                if (r) return !1;
                for (var t = mt || U(), n = Math.max(0, c.startTime + c.duration - t), i = 1 - (n / c.duration || 0), o = 0, a = c.tweens.length; o < a; o++) c.tweens[o].run(i);
        ...
        return _e.map(u, $, c), ve(c.opts.start) && c.opts.start.call(e, c), c.progress(c.opts.progress).done(c.opts.done, c.opts.complete).fail(c.opts.fail).always(c.opts.always), _e.fx.timer(_e.extend(l, {
            elem: e,
            anim: c,
            queue: c.opts.queue
        })), c
    ...
    function J(e, t, n, r) {
        ...
        if (Array.isArray(t)) _e.each(t, function(t, i) {
            n || Dt.test(e) ? r(e, i) : J(e + "[" + ("object" == typeof i && null != i ? t : "") + "]", i, n, r)
        });
    ...
    function ee(e, t, n, i) {
        function r(s) {
            var l;
            return o[s] = !0, _e.each(e[s] || [], function(e, s) {
                var c = s(t, n, i);
    ...
    _e.fn = _e.prototype = {
        ...
        for ("boolean" == typeof a && (c = a, a = arguments[s] || {}, s++), "object" == typeof a || ve(a) || (a = {}), s === l && (a = this, s--); s < l; s++)
            if (null != (e = arguments[s]))
                for (t in e) n = a[t], a !== (i = e[t]) && (c && i && (_e.isPlainObject(i) || (r = Array.isArray(i))) ? (r ? (r = !1, o = n && Array.isArray(n) ? n : []) : o = n && _e.isPlainObject(n) ? n : {}, a[t] = _e.extend(c, o, i)) : void 0 !== i && (a[t] = i));
        return a
    }, _e.extend({
        ...
        isPlainObject: function(e) {
            var t, n;
            return !(!e || "[object Object]" !== fe.call(e) || (t = ae(e)) && ("function" != typeof(n = he.call(t, "constructor") && t.constructor) || pe.call(n) !== ge))
        },
    ...
    var we = function(e) {
        function t(e, t, n, i) {
            ...
            if (!i && ((t ? t.ownerDocument || t : R) !== N && D(t), t = t || N, O)) {
                if (11 !== p && (l = ge.exec(e)))
                    if (r = l[1]) {
                        if (9 === p) {
                ...
                if (_.qsa && !U[e + " "] && (!L || !L.test(e))) {
                    if (1 !== p) h = t, f = e;
                        ...
                        for ((s = t.getAttribute("id")) ? s = s.replace(be, _e) : t.setAttribute("id", s = M), o = (u = T(e)).length; o--;) u[o] = "#" + s + " " + d(u[o]);
        ...
        var b, _, C, w, E, T, x, k, j, S, A, D, N, I, O, L, H, P, Q, M = "sizzle" + 1 * new Date,
            R = e.document,
            F = 0,
            W = 0,
            q = n(),
        ...
        try {
            G.apply(Y = X.call(R.childNodes), R.childNodes), Y[R.childNodes.length].nodeType
        } catch (e) {
            G = {
        ...
        _ = t.support = {}, E = t.isXML = function(e) {
            ...
            return i !== N && 9 === i.nodeType && i.documentElement ? (N = i, I = N.documentElement, O = !E(N), R !== N && (n = N.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", Ce, !1) : n.attachEvent && n.attachEvent("onunload", Ce)), _.attributes = r(function(e) {
                ...
                return n || (1 & (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || !_.sortDetached && t.compareDocumentPosition(e) === n ? e === N || e.ownerDocument === R && Q(R, e) ? -1 : t === N || t.ownerDocument === R && Q(R, t) ? 1 : S ? J(S, e) - J(S, t) : 0 : 4 & n ? -1 : 1)
            } : function(e, t) {
                if (e === t) return A = !0, 0;
                var n, i = 0,
                    r = e.parentNode,
                    ...
                    return 1 === i && 0 === r ? function(e) {
                        ...
                        if (m) {
                            ...
                            if (p = [a ? m.firstChild : m.lastChild], a && y) {
                                for (b = (h = (c = (u = (d = (f = m)[M] || (f[M] = {}))[f.uniqueID] || (d[f.uniqueID] = {}))[e] || [])[0] === F && c[1]) && c[2], f = h && m.childNodes[h]; f = ++h && f && f[g] || (b = h = 0) || p.pop();)
                                    if (1 === f.nodeType && ++b && f === t) {
                                        u[e] = [F, h, b];
                                        break
                                    }
                            } else if (y && (b = h = (c = (u = (d = (f = t)[M] || (f[M] = {}))[f.uniqueID] || (d[f.uniqueID] = {}))[e] || [])[0] === F && c[1]), !1 === b)
                                for (;
                                    (f = ++h && f && f[g] || (b = h = 0) || p.pop()) && ((s ? f.nodeName.toLowerCase() !== v : 1 !== f.nodeType) || !++b || (y && ((u = (d = f[M] || (f[M] = {}))[f.uniqueID] || (d[f.uniqueID] = {}))[e] = [F, b]), f !== t)););
        ...
        return u.prototype = C.filters = C.pseudos, C.setFilters = new u, T = t.tokenize = function(e, n) {
            ...
            var n, i = [],
                ...
                o = U[e + " "];
            if (!o) {
                for (t || (t = T(e)), n = t.length; n--;)(o = v(t[n]))[M] ? i.push(o) : r.push(o);
            ...
            return (u || x(e, f))(i, t, !O, n, !t || me.test(e) && c(t.parentNode) || t), n
        }, _.sortStable = M.split("").sort(V).join("") === M, _.detectDuplicates = !!A, D(), _.sortDetached = r(function(e) {
    ...
    _e.filter = function(e, t, n) {
        ...
        is: function(e) {
            return !!a(this, "string" == typeof e && xe.test(e) ? _e(e) : e || [], !1).length
        }
    });
    var je, Se = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
    (_e.fn.init = function(e, t, n) {
        ...
        if (n = n || je, "string" == typeof e) {
            ...
            if (i[1]) {
                if (t = t instanceof _e ? t[0] : t, _e.merge(this, _e.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : oe, !0)), ke.test(i[1]) && _e.isPlainObject(t))
    ...
    _e.fn.extend({
        ...
        _e.fn[e] = function(n, i) {
            ...
            return "Until" !== e.slice(-5) && (i = n), i && "string" == typeof i && (r = _e.filter(i, r)), this.length > 1 && (De[e] || _e.uniqueSort(r), Ae.test(e) && r.reverse()), this.pushStack(r)
        }
    });
    var Ne = /[^\x20\t\r\n\f]+/g;
    _e.Callbacks = function(e) {
            ...
            d = {
                add: function() {
                    return a && (n && !t && (c = a.length - 1, s.push(n)), function t(n) {
                        _e.each(n, function(n, r) {
                            ve(r) ? e.unique && d.has(r) || a.push(r) : r && r.length && "string" !== i(r) && t(r)
                        })
                ...
                remove: function() {
                    return _e.each(arguments, function(e, t) {
                        for (var n;
                            (n = _e.inArray(t, a, n)) > -1;) a.splice(n, 1), n <= c && c--
                    }), this
                },
                has: function(e) {
                                ...
                                var s = this,
                                    ...
                                    d = function() {
                                        ...
                                        if (!(t < a)) {
                                            ...
                                            d = e && ("object" == typeof e || "function" == typeof e) && e.then, ve(d) ? r ? d.call(e, o(a, n, c, r), o(a, n, u, r)) : (a++, d.call(e, o(a, n, c, r), o(a, n, u, r), o(a, n, c, n.notifyWith))) : (i !== c && (s = void 0, l = [e]), (r || n.resolveWith)(s, l))
                                        }
                                    },
                                    f = r ? d : function() {
                                        try {
                                            ...
                                            _e.Deferred.exceptionHook && _e.Deferred.exceptionHook(e, f.stackTrace), t + 1 >= a && (i !== u && (s = void 0, l = [e]), n.rejectWith(s, l))
                                        }
                                    };
                                t ? f() : (_e.Deferred.getStackHook && (f.stackTrace = _e.Deferred.getStackHook()), e.setTimeout(f))
                            }
                        }
                        var a = 0;
        ...
        when: function(e) {
            var t = arguments.length,
                ...
                a = function(e) {
                    return function(n) {
                        i[e] = this, r[e] = arguments.length > 1 ? se.call(arguments) : n, --t || o.resolveWith(i, r)
                    }
                };
            if (t <= 1 && (d(e, o.done(a(n)).resolve, o.reject, !t), "pending" === o.state() || ve(r[n] && r[n].then))) return o.then();
    ...
    _e.fn.ready = function(e) {
        ...
        readyWait: 1,
        ready: function(e) {
            (!0 === e ? --_e.readyWait : _e.isReady) || (_e.isReady = !0, !0 !== e && --_e.readyWait > 0 || Oe.resolveWith(oe, [_e]))
        }
    }), _e.ready.then = Oe.then, "complete" === oe.readyState || "loading" !== oe.readyState && !oe.documentElement.doScroll ? e.setTimeout(_e.ready) : (oe.addEventListener("DOMContentLoaded", f), e.addEventListener("load", f));
    var Le = function(e, t, n, r, o, a, s) {
            ...
            } else if (void 0 !== r && (o = !0, ve(r) || (s = !0), u && (s ? (t.call(e, r), t = null) : (u = t, t = function(e, t, n) {
    ...
    _e.extend({
        ...
        data: function(e, t) {
            var n, i, r, o = this[0],
                a = o && o.attributes;
            if (void 0 === e) {
                if (this.length && (r = Re.get(o), 1 === o.nodeType && !Me.get(o, "hasDataAttrs"))) {
                    for (n = a.length; n--;) a[n] && 0 === (i = a[n].name).indexOf("data-") && (i = p(i.slice(5)), v(o, i, r[i]));
        ...
        queue: function(e, t, n) {
            var i;
            if (e) return t = (t || "fx") + "queue", i = Me.get(e, t), n && (!i || Array.isArray(n) ? i = Me.access(e, t, _e.makeArray(n)) : i.push(n)), i || []
        },
    ...
    _e.fn.extend({
        ...
        toggle: function(e) {
            return "boolean" == typeof e ? e ? this.show() : this.hide() : this.each(function() {
                Ve(this) ? _e(this).show() : _e(this).hide()
            })
        }
    });
    ...
    _e.event = {
        ...
        add: function(e, t, n, i, r) {
            ...
            if (m)
                for (n.handler && (n = (o = n).handler, r = o.selector), r && _e.find.matchesSelector(Ze, r), n.guid || (n.guid = _e.guid++), (l = m.events) || (l = m.events = {}), (a = m.handle) || (a = m.handle = function(t) {
                        return void 0 !== _e && _e.event.triggered !== t.type ? _e.event.dispatch.apply(e, arguments) : void 0
                    }), c = (t = (t || "").match(Ne) || [""]).length; c--;) h = g = (s = nt.exec(t[c]) || [])[1], p = (s[2] || "").split(".").sort(), h && (d = _e.event.special[h] || {}, h = (r ? d.delegateType : d.bindType) || h, d = _e.event.special[h] || {}, u = _e.extend({
                    type: h,
                    origType: g,
                    data: i,
                    handler: n,
                    ...
                    namespace: p.join(".")
                }, o), (f = l[h]) || ((f = l[h] = []).delegateCount = 0, d.setup && !1 !== d.setup.call(e, i, p, a) || e.addEventListener && e.addEventListener(h, a)), d.add && (d.add.call(e, u), u.handler.guid || (u.handler.guid = n.guid)), r ? f.splice(f.delegateCount++, 0, u) : f.push(u), _e.event.global[h] = !0)
        },
            ...
            if (m && (l = m.events)) {
                for (c = (t = (t || "").match(Ne) || [""]).length; c--;)
                    if (s = nt.exec(t[c]) || [], h = g = s[1], p = (s[2] || "").split(".").sort(), h) {
                        for (d = _e.event.special[h] || {}, f = l[h = (i ? d.delegateType : d.bindType) || h] || [], s = s[2] && new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)"), a = o = f.length; o--;) u = f[o], !r && g !== u.origType || n && n.guid !== u.guid || s && !s.test(u.namespace) || i && i !== u.selector && ("**" !== i || !u.selector) || (f.splice(o, 1), u.selector && f.delegateCount--, d.remove && d.remove.call(e, u));
                        a && !f.length && (d.teardown && !1 !== d.teardown.call(e, p, m.handle) || _e.removeEvent(e, h, m.handle), delete l[h])
                    } else
                        for (h in l) _e.event.remove(e, h + t[c], n, i, !0);
                _e.isEmptyObject(l) && Me.remove(e, "handle events")
            }
        },
        dispatch: function(e) {
            var t, n, i, r, o, a, s = _e.event.fix(e),
                l = new Array(arguments.length),
                c = (Me.get(this, "events") || {})[s.type] || [],
                u = _e.event.special[s.type] || {};
            for (l[0] = s, t = 1; t < arguments.length; t++) l[t] = arguments[t];
            if (s.delegateTarget = this, !u.preDispatch || !1 !== u.preDispatch.call(this, s)) {
                for (a = _e.event.handlers.call(this, s, c), t = 0;
                    (r = a[t++]) && !s.isPropagationStopped();)
                    for (s.currentTarget = r.elem, n = 0;
                        (o = r.handlers[n++]) && !s.isImmediatePropagationStopped();) s.rnamespace && !s.rnamespace.test(o.namespace) || (s.handleObj = o, s.data = o.data, void 0 !== (i = ((_e.event.special[o.origType] || {}).handle || o.handler).apply(r.elem, l)) && !1 === (s.result = i) && (s.preventDefault(), s.stopPropagation()));
            ...
            if (l && c.nodeType && !("click" === e.type && e.button >= 1))
                for (; c !== this; c = c.parentNode || this)
                    if (1 === c.nodeType && ("click" !== e.type || !0 !== c.disabled)) {
                        for (o = [], a = {}, n = 0; n < l; n++) void 0 === a[r = (i = t[n]).selector + " "] && (a[r] = i.needsContext ? _e(r, this).index(c) > -1 : _e.find(r, this, null, [c]).length), a[r] && o.push(i);
                        o.length && s.push({
                            elem: c,
                            handlers: o
                        })
        ...
        e && e.type ? (this.originalEvent = e, this.type = e.type, this.isDefaultPrevented = e.defaultPrevented || void 0 === e.defaultPrevented && !1 === e.returnValue ? T : x, this.target = e.target && 3 === e.target.nodeType ? e.target.parentNode : e.target, this.currentTarget = e.currentTarget, this.relatedTarget = e.relatedTarget) : this.type = e, t && _e.extend(this, t), this.timeStamp = e && e.timeStamp || Date.now(), this[_e.expando] = !0
    }, _e.Event.prototype = {
    ...
    _e.extend({
        ...
        clone: function(e, t, n) {
            ...
            if (!(me.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || _e.isXMLDoc(e)))
                for (a = C(s), i = 0, r = (o = C(e)).length; i < r; i++) I(o[i], a[i]);
            if (t)
                if (n)
                    for (o = o || C(e), a = a || C(s), i = 0, r = o.length; i < r; i++) N(o[i], a[i]);
                else N(e, s);
            return (a = C(s, "script")).length > 0 && w(a, !l && C(e, "script")), s
        },
        ...
        empty: function() {
            for (var e, t = 0; null != (e = this[t]); t++) 1 === e.nodeType && (_e.cleanData(C(e, !1)), e.textContent = "");
            return this
        },
        clone: function(e, t) {
        ...
        html: function(e) {
            return Le(this, function(e) {
                ...
                if ("string" == typeof e && !rt.test(e) && !Xe[(ze.exec(e) || ["", ""])[1].toLowerCase()]) {
                    e = _e.htmlPrefilter(e);
                    try {
                        for (; n < i; n++) 1 === (t = this[n] || {}).nodeType && (_e.cleanData(C(t, !1)), t.innerHTML = e);
                        t = 0
                    } catch (e) {}
                }
        ...
        replaceWith: function() {
            ...
            return O(this, arguments, function(t) {
                ...
                _e.inArray(this, e) < 0 && (_e.cleanData(C(this)), n && n.replaceChild(t, this))
            }, e)
        }
    }), _e.each({
        appendTo: "append",
        ...
        _e.fn[e] = function(e) {
            for (var n, i = [], r = _e(e), o = r.length - 1, a = 0; a <= o; a++) n = a === o ? this : this.clone(!0), _e(r[a])[t](n), ce.apply(i, n.get());
    ...
    ! function() {
        function t() {
            if (c) {
                ...
                i = "1%" !== t.top, s = 12 === n(t.marginLeft), c.style.right = "60%", a = 36 === n(t.right), r = 36 === n(t.width), c.style.position = "absolute", o = 36 === c.offsetWidth || "absolute", Ze.removeChild(l), c = null
            }
        }
        ...
        var i, r, o, a, s, l = oe.createElement("div"),
            c = oe.createElement("div");
        c.style && (c.style.backgroundClip = "content-box", c.cloneNode(!0).style.backgroundClip = "", me.clearCloneStyle = "content-box" === c.style.backgroundClip, _e.extend(me, {
    ...
    _e.extend({
        ...
        style: function(e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var r, o, a, s = p(t),
                    l = dt.test(t),
                    c = e.style;
                if (l || (t = M(s)), a = _e.cssHooks[t] || _e.cssHooks[s], void 0 === n) return a && "get" in a && void 0 !== (r = a.get(e, !1, i)) ? r : c[t];
                "string" == (o = typeof n) && (r = Be.exec(n)) && r[1] && (n = y(e, t, r), o = "number"), null != n && n === n && ("number" === o && (n += r && r[3] || (_e.cssNumber[s] ? "" : "px")), me.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (c[t] = "inherit"), a && "set" in a && void 0 === (n = a.set(e, n, i)) || (l ? c.setProperty(t, n) : c[t] = n))
            }
        },
        css: function(e, t, n, i) {
            var r, o, a, s = p(t);
            return dt.test(t) || (t = M(s)), (a = _e.cssHooks[t] || _e.cssHooks[s]) && "get" in a && (r = a.get(e, !0, n)), void 0 === r && (r = H(e, t, i)), "normal" === r && t in ht && (r = ht[t]), "" === n || n ? (o = parseFloat(r), !0 === n || isFinite(o) ? o || 0 : r) : r
        }
    }), _e.each(["height", "width"], function(e, t) {
        _e.cssHooks[t] = {
            get: function(e, n, i) {
                if (n) return !ut.test(_e.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? W(e, t, i) : $e(e, ft, function() {
                    return W(e, t, i)
                })
            },
            set: function(e, n, i) {
                var r, o = lt(e),
                    ...
                    s = i && F(e, t, i, a, o);
                return a && me.scrollboxSize() === o.position && (s -= Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - parseFloat(o[t]) - F(e, t, "border", !1, o) - .5)), s && (r = Be.exec(n)) && "px" !== (r[3] || "px") && (e.style[t] = n, n = _e.css(e, t)), R(e, n, s)
            }
        }
    }), _e.cssHooks.marginLeft = P(me.reliableMarginLeft, function(e, t) {
        if (t) return (parseFloat(H(e, "marginLeft")) || e.getBoundingClientRect().left - $e(e, {
            marginLeft: 0
        }, function() {
        ...
        css: function(e, t) {
            return Le(this, function(e, t, n) {
                var i, r, o = {},
                    a = 0;
                if (Array.isArray(t)) {
                    for (i = lt(e), r = t.length; a < r; a++) o[t[a]] = _e.css(e, t[a], !1, i);
                    return o
                }
                return void 0 !== n ? _e.style(e, t, n) : _e.css(e, t)
            }, e, t, arguments.length > 1)
        }
    }), _e.Tween = q, q.prototype = {
        constructor: q,
        ...
        run: function(e) {
            ...
            return this.options.duration ? this.pos = t = _e.easing[this.easing](e, this.options.duration * e, 0, 1, this.options.duration) : this.pos = t = e, this.now = (this.end - this.start) * t + this.start, this.options.step && this.options.step.call(this.elem, this.now, this), n && n.set ? n.set(this) : q.propHooks._default.set(this), this
        }
        ...
        _default: "swing"
    }, _e.fx = q.prototype.init, _e.fx.step = {};
    var mt, vt, yt = /^(?:toggle|show|hide)$/,
        bt = /queueHooks$/;
    _e.Animation = _e.extend(K, {
            ...
            prefilters: [function(e, t, n) {
                var i, r, o, a, s, l, c, u, d = "width" in t || "height" in t,
                    ...
                    g = e.nodeType && Ve(e),
                    m = Me.get(e, "fxshow");
                n.queue || (null == (a = _e._queueHooks(e, "fx")).unqueued && (a.unqueued = 0, s = a.empty.fire, a.empty.fire = function() {
                    a.unqueued || s()
                ...
                if ((l = !_e.isEmptyObject(t)) || !_e.isEmptyObject(h)) {
                    d && 1 === e.nodeType && (n.overflow = [p.overflow, p.overflowX, p.overflowY], null == (c = m && m.display) && (c = Me.get(e, "display")), "none" === (u = _e.css(e, "display")) && (c ? u = c : (_([e], !0), c = e.style.display || c, u = _e.css(e, "display"), _([e]))), ("inline" === u || "inline-block" === u && null != c) && "none" === _e.css(e, "float") && (l || (f.done(function() {
                        p.display = c
                    }), null == c && (u = p.display, c = "none" === u ? "" : u)), p.display = "inline-block")), n.overflow && (p.overflow = "hidden", f.always(function() {
                        p.overflow = n.overflow[0], p.overflowX = n.overflow[1], p.overflowY = n.overflow[2]
                    })), l = !1;
                    for (i in h) l || (m ? "hidden" in m && (g = m.hidden) : m = Me.access(e, "fxshow", {
                        display: c
                    }), o && (m.hidden = !g), g && _([e], !0), f.done(function() {
                        g || _([e]), Me.remove(e, "fxshow");
            ...
            stop: function(e, t, n) {
                ...
                return "string" != typeof e && (n = t, t = e, e = void 0), t && !1 !== e && this.queue(e || "fx", []), this.each(function() {
                    ...
                    if (r) a[r] && a[r].stop && i(a[r]);
                        ...
                        for (r in a) a[r] && a[r].stop && bt.test(r) && i(a[r]);
    ...
    _e.fn.extend({
    ...
    }), me.optSelected || (_e.propHooks.selected = {
        get: function(e) {
            var t = e.parentNode;
        ...
        addClass: function(e) {
            ...
            if (ve(e)) return this.each(function(t) {
                _e(this).addClass(e.call(this, t, G(this)))
            });
            if ((t = X(e)).length)
                for (; n = this[l++];)
        ...
        removeClass: function(e) {
            var t, n, i, r, o, a, s, l = 0;
            if (ve(e)) return this.each(function(t) {
                _e(this).removeClass(e.call(this, t, G(this)))
            });
        ...
        toggleClass: function(e, t) {
            ...
            return "boolean" == typeof t && i ? t ? this.addClass(e) : this.removeClass(e) : ve(e) ? this.each(function(n) {
                _e(this).toggleClass(e.call(this, n, G(this), t), t)
            }) : this.each(function() {
                var t, r, o, a;
                if (i)
                    for (r = 0, o = _e(this), a = X(e); t = a[r++];) o.hasClass(t) ? o.removeClass(t) : o.addClass(t);
                else void 0 !== e && "boolean" !== n || ((t = G(this)) && Me.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", t || !1 === e ? "" : Me.get(this, "__className__") || ""))
            })
        },
        hasClass: function(e) {
            var t, n, i = 0;
    ...
    _e.fn.extend({
        ...
        valHooks: {
            ...
            select: {
                ...
                set: function(e, t) {
                    for (var n, i, r = e.options, o = _e.makeArray(t), a = r.length; a--;)((i = r[a]).selected = _e.inArray(_e.valHooks.option.get(i), o) > -1) && (n = !0);
        ...
        }, me.checkOn || (_e.valHooks[this].get = function(e) {
    ...
    _e.extend(_e.event, {
        trigger: function(t, n, i, r) {
            var o, a, s, l, c, u, d, f, h = [i || oe],
                p = he.call(t, "type") ? t.type : t,
                g = he.call(t, "namespace") ? t.namespace.split(".") : [];
            if (a = f = s = i = i || oe, 3 !== i.nodeType && 8 !== i.nodeType && !xt.test(p + _e.event.triggered) && (p.indexOf(".") > -1 && (p = (g = p.split(".")).shift(), g.sort()), c = p.indexOf(":") < 0 && "on" + p, t = t[_e.expando] ? t : new _e.Event(p, "object" == typeof t && t), t.isTrigger = r ? 2 : 3, t.namespace = g.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + g.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = i), n = null == n ? [t] : _e.makeArray(n, [t]), d = _e.event.special[p] || {}, r || !d.trigger || !1 !== d.trigger.apply(i, n))) {
                if (!r && !d.noBubble && !ye(i)) {
                    for (l = d.delegateType || p, xt.test(l + p) || (a = a.parentNode); a; a = a.parentNode) h.push(a), s = a;
                    s === (i.ownerDocument || oe) && h.push(s.defaultView || s.parentWindow || e)
                }
                for (o = 0;
                    (a = h[o++]) && !t.isPropagationStopped();) f = a, t.type = o > 1 ? l : d.bindType || p, (u = (Me.get(a, "events") || {})[t.type] && Me.get(a, "handle")) && u.apply(a, n), (u = c && a[c]) && u.apply && Qe(a) && (t.result = u.apply(a, n), !1 === t.result && t.preventDefault());
                return t.type = p, r || t.isDefaultPrevented() || d._default && !1 !== d._default.apply(h.pop(), n) || !Qe(i) || c && ve(i[p]) && !ye(i) && ((s = i[c]) && (i[c] = null), _e.event.triggered = p, t.isPropagationStopped() && f.addEventListener(p, kt), i[p](), t.isPropagationStopped() && f.removeEventListener(p, kt), _e.event.triggered = void 0, s && (i[c] = s)), t.result
            }
        },
    ...
    _e.param = function(e, t) {
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var e = this.type;
                return this.name && !_e(this).is(":disabled") && Ot.test(this.nodeName) && !It.test(e) && (this.checked || !Ke.test(e))
            }).map(function(e, t) {
                var n = _e(this).val();
    ...
    Ut.href = jt.href, _e.extend({
        ...
        ajax: function(t, n) {
            function i(t, n, i, s) {
                var c, f, h, _, C, w = n;
                u || (u = !0, l && e.clearTimeout(l), r = void 0, a = s || "", E.readyState = t > 0 ? 4 : 0, c = t >= 200 && t < 300 || 304 === t, i && (_ = ne(p, E, i)), _ = ie(p, _, E, c), c ? (p.ifModified && ((C = E.getResponseHeader("Last-Modified")) && (_e.lastModified[o] = C), (C = E.getResponseHeader("etag")) && (_e.etag[o] = C)), 204 === t || "HEAD" === p.type ? w = "nocontent" : 304 === t ? w = "notmodified" : (w = _.state, f = _.data, c = !(h = _.error))) : (h = w, !t && w || (w = "error", t < 0 && (t = 0))), E.status = t, E.statusText = (n || w) + "", c ? v.resolveWith(g, [f, w, E]) : v.rejectWith(g, [E, w, h]), E.statusCode(b), b = void 0, d && m.trigger(c ? "ajaxSuccess" : "ajaxError", [E, p, c ? f : h]), y.fireWith(g, [E, w]), d && (m.trigger("ajaxComplete", [E, p]), --_e.active || _e.event.trigger("ajaxStop")))
            }
            "object" == typeof t && (n = t, t = void 0), n = n || {};
            var r, o, a, s, l, c, u, d, f, h, p = _e.ajaxSetup({}, n),
                g = p.context || p,
            ...
            if (v.promise(E), p.url = ((t || p.url || jt.href) + "").replace(Ft, jt.protocol + "//"), p.type = n.method || n.type || p.method || p.type, p.dataTypes = (p.dataType || "*").toLowerCase().match(Ne) || [""], null == p.crossDomain) {
            ...
            if (p.data && p.processData && "string" != typeof p.data && (p.data = _e.param(p.data, p.traditional)), ee(Wt, p, n, E), u) return E;
            (d = _e.event && p.global) && 0 == _e.active++ && _e.event.trigger("ajaxStart"), p.type = p.type.toUpperCase(), p.hasContent = !Rt.test(p.type), o = p.url.replace(Ht, ""), p.hasContent ? p.data && p.processData && 0 === (p.contentType || "").indexOf("application/x-www-form-urlencoded") && (p.data = p.data.replace(Lt, "+")) : (h = p.url.slice(o.length), p.data && (p.processData || "string" == typeof p.data) && (o += (At.test(o) ? "&" : "?") + p.data, delete p.data), !1 === p.cache && (o = o.replace(Pt, "$1"), h = (At.test(o) ? "&" : "?") + "_=" + St++ + h), p.url = o + h), p.ifModified && (_e.lastModified[o] && E.setRequestHeader("If-Modified-Since", _e.lastModified[o]), _e.etag[o] && E.setRequestHeader("If-None-Match", _e.etag[o])), (p.data && p.hasContent && !1 !== p.contentType || n.contentType) && E.setRequestHeader("Content-Type", p.contentType), E.setRequestHeader("Accept", p.dataTypes[0] && p.accepts[p.dataTypes[0]] ? p.accepts[p.dataTypes[0]] + ("*" !== p.dataTypes[0] ? ", " + Bt + "; q=0.01" : "") : p.accepts["*"]);
            for (f in p.headers) E.setRequestHeader(f, p.headers[f]);
            if (p.beforeSend && (!1 === p.beforeSend.call(g, E, p) || u)) return E.abort();
            if (w = "abort", y.add(p.complete), E.done(p.success), E.fail(p.error), r = ee(qt, p, n, E)) {
    ...
    me.cors = !!$t && "withCredentials" in $t, me.ajax = $t = !!$t, _e.ajaxTransport(function(t) {
        var n, i;
        if (me.cors || $t && !t.crossDomain) return {
            send: function(r, o) {
                var a, s = t.xhr();
    ...
    _e.ajaxSetup({
        ...
        if (s || "jsonp" === t.dataTypes[0]) return r = t.jsonpCallback = ve(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, s ? t[s] = t[s].replace(Kt, "$1" + r) : !1 !== t.jsonp && (t.url += (At.test(t.url) ? "&" : "?") + t.jsonp + "=" + r), t.converters["script json"] = function() {
            return a || _e.error(r + " was not called"), a[0]
        }, t.dataTypes[0] = "json", o = e[r], e[r] = function() {
            a = arguments
        }, i.always(function() {
            void 0 === o ? _e(e).removeProp(r) : e[r] = o, t[r] && (t.jsonpCallback = n.jsonpCallback, Yt.push(r)), a && ve(o) && o(a[0]), a = o = void 0
        }), "script"
        ...
        var i, r, o;
        return t || (me.createHTMLDocument ? ((i = (t = oe.implementation.createHTMLDocument("")).createElement("base")).href = oe.location.href, t.head.appendChild(i)) : t = oe), r = ke.exec(e), o = !n && [], r ? [t.createElement(r[1])] : (r = E([e], t, o), o && o.length && _e(o).remove(), _e.merge([], r.childNodes))
    }, _e.fn.load = function(e, t, n) {
        var i, r, o, a = this,
            s = e.indexOf(" ");
        return s > -1 && (i = z(e.slice(s)), e = e.slice(0, s)), ve(t) ? (n = t, t = void 0) : t && "object" == typeof t && (r = "POST"), a.length > 0 && _e.ajax({
            url: e,
            type: r || "GET",
            dataType: "html",
            data: t
        }).done(function(e) {
            o = arguments, a.html(i ? _e("<div>").append(_e.parseHTML(e)).find(i) : e)
        ...
        setOffset: function(e, t, n) {
            var i, r, o, a, s, l, c = _e.css(e, "position"),
                u = _e(e),
                d = {};
            "static" === c && (e.style.position = "relative"), s = u.offset(), o = _e.css(e, "top"), l = _e.css(e, "left"), ("absolute" === c || "fixed" === c) && (o + l).indexOf("auto") > -1 ? (a = (i = u.position()).top, r = i.left) : (a = parseFloat(o) || 0, r = parseFloat(l) || 0), ve(t) && (t = t.call(e, n, _e.extend({}, s))), null != t.top && (d.top = t.top - s.top + a), null != t.left && (d.left = t.left - s.left + r), "using" in t ? t.using.call(e, d) : u.css(d)
        }
    }, _e.fn.extend({
        offset: function(e) {
        ...
        _e.cssHooks[t] = P(me.pixelPosition, function(e, n) {
            if (n) return n = H(e, t), st.test(n) ? _e(e).position()[t] + "px" : n
        })
    }), _e.each({
        Height: "height",
        Width: "width"
        ...
        _e.each({
            ...
            _e.fn[i] = function(r, o) {
                ...
                return Le(this, function(t, n, r) {
                    var o;
                    return ye(t) ? 0 === i.indexOf("outer") ? t["inner" + e] : t.document.documentElement["client" + e] : 9 === t.nodeType ? (o = t.documentElement, Math.max(t.body["scroll" + e], o["scroll" + e], t.body["offset" + e], o["offset" + e], o["client" + e])) : void 0 === r ? _e.css(t, n, s) : _e.style(t, n, r, s)
                }, t, a ? r : void 0, a)
            }
        })
        ...
        var n, i, r;
        if ("string" == typeof t && (n = e[t], t = e, e = n), ve(e)) return i = se.call(arguments, 2), r = function() {
    ...
    return _e.noConflict = function(t) {
        return e.$ === _e && (e.$ = Gt), t && e.jQuery === _e && (e.jQuery = zt), _e
    }, t || (e.jQuery = e.$ = _e), _e
}),
function(e, t) {
    ...
    function c(e) {
        ...
        var i = n && n.nodeName;
        return i && "BODY" !== i && "HTML" !== i ? -1 !== ["TD", "TABLE"].indexOf(n.nodeName) && "static" === a(n, "position") ? c(n) : n : e ? e.ownerDocument.documentElement : document.documentElement
    }
    ...
    function y(e, t) {
        ...
        if (p.marginTop = 0, p.marginLeft = 0, !i && r) {
            ...
            p.top -= d - g, p.bottom -= d - g, p.left -= h - y, p.right -= h - y, p.marginTop = g, p.marginLeft = y
        }
        ...
        if ("viewport" === i) o = function(e) {
            ...
            if ("HTML" !== u.nodeName || function e(t) {
                ...
                var p = g(),
                    v = p.height,
                    _ = p.width;
                o.top += h.top - h.marginTop, o.bottom = v + h.top, o.left += h.left - h.marginLeft, o.right = _ + h.left
            }
        }
    ...
    function L(e, t) {
        Object.keys(t).forEach(function(n) {
            var i = ""; - 1 !== ["width", "height", "top", "right", "bottom", "left"].indexOf(n) && O(t[n]) && (i = "px"), e.style[n] = t[n] + i
        })
    }
    ...
    for (var M, R, F, W, q, B, U, V, $, Y, K, z, G, X, J, Z, ee, te, ne, ie, re, oe, ae, se, le, ce, ue, de, fe, he, pe, ge, me, ve, ye, be, _e, Ce, we, Ee, Te, xe, ke, je, Se, Ae, De, Ne, Ie, Oe, Le, He, Pe, Qe, Me, Re, Fe, We, qe, Be, Ue, Ve, $e, Ye, Ke = function(e) {
            var t = "transitionend",
                n = {
        ...
        }(t = t && t.hasOwnProperty("default") ? t.default : t), ze = (R = "alert", W = "." + (F = "bs.alert"), q = (M = t).fn[R], B = {
            CLOSE: "close" + W,
            CLOSED: "closed" + W,
            CLICK_DATA_API: "click" + W + ".data-api"
        }, U = "alert", V = "fade", $ = "show", Y = function() {
            function e(e) {
                this._element = e
            }
            var t = e.prototype;
            return t.close = function(e) {
                ...
                M.removeData(this._element, F), this._element = null
            }, t._getRootElement = function(e) {
                var t = Ke.getSelectorFromElement(e),
                    n = !1;
                return t && (n = M(t)[0]), n || (n = M(e).closest("." + U)[0]), n
            }, t._triggerCloseEvent = function(e) {
                var t = M.Event(B.CLOSE);
                return M(e).trigger(t), t
            }, t._removeElement = function(e) {
                var t = this;
                if (M(e).removeClass($), M(e).hasClass(V)) {
                    var n = Ke.getTransitionDurationFromElement(e);
                    M(e).one(Ke.TRANSITION_END, function(n) {
                        return t._destroyElement(e, n)
                    }).emulateTransitionEnd(n)
                } else this._destroyElement(e)
            }, t._destroyElement = function(e) {
                M(e).detach().trigger(B.CLOSED).remove()
        ...
        }(), M(document).on(B.CLICK_DATA_API, '[data-dismiss="alert"]', Y._handleDismiss(new Y)), M.fn[R] = Y._jQueryInterface, M.fn[R].Constructor = Y, M.fn[R].noConflict = function() {
            return M.fn[R] = q, Y._jQueryInterface
        }, Y), Ge = (z = "button", X = "." + (G = "bs.button"), J = ".data-api", Z = (K = t).fn[z], ee = "active", te = "btn", ie = '[data-toggle^="button"]', re = '[data-toggle="buttons"]', oe = "input", ae = ".active", se = ".btn", le = {
            CLICK_DATA_API: "click" + X + J,
            FOCUS_BLUR_DATA_API: (ne = "focus") + X + J + " blur" + X + J
        }, ce = function() {
            function e(e) {
                this._element = e
            }
            ...
            return t.toggle = function() {
                ...
                return this.each(function() {
                    var n = K(this).data(G);
                    n || (n = new e(this), K(this).data(G, n)), "toggle" === t && n[t]()
                })
            }, i(e, null, [{
                key: "VERSION",
                get: function() {
            ...
            e.preventDefault();
            var t = e.target;
            K(t).hasClass("btn") || (t = K(t).closest(se)), ce._jQueryInterface.call(K(t), "toggle")
        }).on(le.FOCUS_BLUR_DATA_API, ie, function(e) {
            var t = K(e.target).closest(se)[0];
            K(t).toggleClass(ne, /^focus(in)?$/.test(e.type))
        }), K.fn[z] = ce._jQueryInterface, K.fn[z].Constructor = ce, K.fn[z].noConflict = function() {
            return K.fn[z] = Z, ce._jQueryInterface
        }, ce), Xe = (de = "carousel", he = "." + (fe = "bs.carousel"), pe = ".data-api", ge = (ue = t).fn[de], me = {
            interval: 5e3,
            keyboard: !0,
            slide: !1,
            pause: "hover",
            ...
            wrap: "boolean"
        }, ye = "next", be = "prev", _e = "left", Ce = "right", we = {
            SLIDE: "slide" + he,
            SLID: "slid" + he,
            KEYDOWN: "keydown" + he,
            ...
            LOAD_DATA_API: "load" + he + pe,
            CLICK_DATA_API: "click" + he + pe
        }, Ee = "carousel", Te = "active", xe = "slide", ke = "carousel-item-right", je = "carousel-item-left", Se = "carousel-item-next", Ae = "carousel-item-prev", De = {
            ACTIVE: ".active",
            ...
            function e(e, t) {
                this._items = null, this._interval = null, this._activeElement = null, this._isPaused = !1, this._isSliding = !1, this.touchTimeout = null, this._config = this._getConfig(t), this._element = ue(e)[0], this._indicatorsElement = ue(this._element).find(De.INDICATORS)[0], this._addEventListeners()
            }
            var t = e.prototype;
            return t.next = function() {
                ...
                e || (this._isPaused = !0), ue(this._element).find(De.NEXT_PREV)[0] && (Ke.triggerTransitionEnd(this._element), this.cycle(!0)), clearInterval(this._interval), this._interval = null
            }, t.cycle = function(e) {
                e || (this._isPaused = !1), this._interval && (clearInterval(this._interval), this._interval = null), this._config.interval && !this._isPaused && (this._interval = setInterval((document.visibilityState ? this.nextWhenVisible : this.next).bind(this), this._config.interval))
            }, t.to = function(e) {
                var t = this;
                this._activeElement = ue(this._element).find(De.ACTIVE_ITEM)[0];
                ...
                ue(this._element).off(he), ue.removeData(this._element, fe), this._items = null, this._config = null, this._element = null, this._interval = null, this._isPaused = null, this._isSliding = null, this._activeElement = null, this._indicatorsElement = null
            }, t._getConfig = function(e) {
                return e = r({}, me, e), Ke.typeCheckConfig(de, e, ve), e
                ...
                return this._items = ue.makeArray(ue(e).parent().find(De.ITEM)), this._items.indexOf(e)
                ...
                var a = (r + (e === be ? -1 : 1)) % this._items.length;
                return -1 === a ? this._items[this._items.length - 1] : this._items[a]
            }, t._triggerSlideEvent = function(e, t) {
                var n = this._getItemIndex(e),
                    i = this._getItemIndex(ue(this._element).find(De.ACTIVE_ITEM)[0]),
                    r = ue.Event(we.SLIDE, {
                        relatedTarget: e,
                        direction: t,
                        from: i,
                ...
                if (this._indicatorsElement) {
                    ue(this._indicatorsElement).find(De.ACTIVE).removeClass(Te);
                    var t = this._indicatorsElement.children[this._getItemIndex(e)];
                    t && ue(t).addClass(Te)
                }
            }, t._slide = function(e, t) {
                var n, i, r, o = this,
                    a = ue(this._element).find(De.ACTIVE_ITEM)[0],
                    s = this._getItemIndex(a),
                    l = t || a && this._getItemByDirection(e, a),
                    c = this._getItemIndex(l),
                    u = Boolean(this._interval);
                if (e === ye ? (n = je, i = Se, r = _e) : (n = ke, i = Ae, r = Ce), l && ue(l).hasClass(Te)) this._isSliding = !1;
                else if (!this._triggerSlideEvent(l, r).isDefaultPrevented() && a && l) {
                    this._isSliding = !0, u && this.pause(), this._setActiveIndicatorElement(l);
                    var d = ue.Event(we.SLID, {
                        relatedTarget: l,
                        direction: r,
                        from: s,
                        to: c
                    });
                    if (ue(this._element).hasClass(xe)) {
                        ue(l).addClass(i), Ke.reflow(l), ue(a).addClass(n), ue(l).addClass(n);
                        var f = Ke.getTransitionDurationFromElement(a);
                        ue(a).one(Ke.TRANSITION_END, function() {
                            ue(l).removeClass(n + " " + i).addClass(Te), ue(a).removeClass(Te + " " + i + " " + n), o._isSliding = !1, setTimeout(function() {
                                return ue(o._element).trigger(d)
                            }, 0)
                        }).emulateTransitionEnd(f)
                    } else ue(a).removeClass(Te), ue(l).addClass(Te), this._isSliding = !1, ue(this._element).trigger(d);
                    u && this.cycle()
                }
            }, e._jQueryInterface = function(t) {
                return this.each(function() {
                    var n = ue(this).data(fe),
                        i = r({}, me, ue(this).data());
                    "object" == typeof t && (i = r({}, i, t));
                    var o = "string" == typeof t ? t : i.slide;
                    if (n || (n = new e(this, i), ue(this).data(fe, n)), "number" == typeof t) n.to(t);
                ...
                if (n) {
                    var i = ue(n)[0];
                    if (i && ue(i).hasClass(Ee)) {
                        var o = r({}, ue(i).data(), ue(this).data()),
                            a = this.getAttribute("data-slide-to");
                        a && (o.interval = !1), e._jQueryInterface.call(ue(i), o), a && ue(i).data(fe).to(a), t.preventDefault()
                    }
                }
            }, i(e, null, [{
                key: "VERSION",
        ...
        }(), ue(document).on(we.CLICK_DATA_API, De.DATA_SLIDE, Ne._dataApiClickHandler), ue(window).on(we.LOAD_DATA_API, function() {
            ue(De.DATA_RIDE).each(function() {
                var e = ue(this);
                Ne._jQueryInterface.call(e, e.data())
            })
        }), ue.fn[de] = Ne._jQueryInterface, ue.fn[de].Constructor = Ne, ue.fn[de].noConflict = function() {
            return ue.fn[de] = ge, Ne._jQueryInterface
        }, Ne), Je = (Oe = "collapse", He = "." + (Le = "bs.collapse"), Pe = (Ie = t).fn[Oe], Qe = {
            toggle: !0,
            parent: ""
        }, Me = {
            toggle: "boolean",
        ...
        }, Fe = "show", We = "collapse", qe = "collapsing", Be = "collapsed", Ue = "width", Ve = "height", $e = {
            ...
            function e(e, t) {
                ...
                for (var n = Ie($e.DATA_TOGGLE), i = 0; i < n.length; i++) {
                    var r = n[i],
            ...
            return t.toggle = function() {
                ...
                var t, n, i = this;
                if (!(this._isTransitioning || Ie(this._element).hasClass(Fe) || (this._parent && 0 === (t = Ie.makeArray(Ie(this._parent).find($e.ACTIVES).filter('[data-parent="' + this._config.parent + '"]'))).length && (t = null), t && (n = Ie(t).not(this._selector).data(Le)) && n._isTransitioning))) {
                    var r = Ie.Event(Re.SHOW);
                    if (Ie(this._element).trigger(r), !r.isDefaultPrevented()) {
                        ...
                        Ie(this._element).removeClass(We).addClass(qe), (this._element.style[o] = 0) < this._triggerArray.length && Ie(this._triggerArray).removeClass(Be).attr("aria-expanded", !0), this.setTransitioning(!0);
                        ...
                        Ie(this._element).one(Ke.TRANSITION_END, function() {
                            Ie(i._element).removeClass(qe).addClass(We).addClass(Fe), i._element.style[o] = "", i.setTransitioning(!1), Ie(i._element).trigger(Re.SHOWN)
                ...
                if (!this._isTransitioning && Ie(this._element).hasClass(Fe)) {
                    var t = Ie.Event(Re.HIDE);
                    if (Ie(this._element).trigger(t), !t.isDefaultPrevented()) {
                        var n = this._getDimension();
                        if (this._element.style[n] = this._element.getBoundingClientRect()[n] + "px", Ke.reflow(this._element), Ie(this._element).addClass(qe).removeClass(We).removeClass(Fe), 0 < this._triggerArray.length)
                            for (var i = 0; i < this._triggerArray.length; i++) {
                                var r = this._triggerArray[i],
                                    o = Ke.getSelectorFromElement(r);
                                null !== o && (Ie(o).hasClass(Fe) || Ie(r).addClass(Be).attr("aria-expanded", !1))
                            }
                        this.setTransitioning(!0), this._element.style[n] = "";
                        var a = Ke.getTransitionDurationFromElement(this._element);
                        Ie(this._element).one(Ke.TRANSITION_END, function() {
                            e.setTransitioning(!1), Ie(e._element).removeClass(qe).addClass(We).trigger(Re.HIDDEN)
                ...
                return (e = r({}, Qe, e)).toggle = Boolean(e.toggle), Ke.typeCheckConfig(Oe, e, Me), e
            }, t._getDimension = function() {
                return Ie(this._element).hasClass(Ue) ? Ue : "height"
                ...
                if (e) {
                    ...
                    0 < t.length && Ie(t).toggleClass(Be, !n).attr("aria-expanded", n)
                }
                ...
                return this.each(function() {
                    var n = Ie(this),
                        i = n.data(Le),
                        o = r({}, Qe, n.data(), "object" == typeof t && t);
        ...
        }(), Ie(document).on(Re.CLICK_DATA_API, $e.DATA_TOGGLE, function(e) {
            ...
            Ie(n).each(function() {
                ...
                Ye._jQueryInterface.call(e, n)
            })
        }), Ie.fn[Oe] = Ye._jQueryInterface, Ie.fn[Oe].Constructor = Ye, Ie.fn[Oe].noConflict = function() {
            return Ie.fn[Oe] = Pe, Ye._jQueryInterface
        }, Ye), Ze = "undefined" != typeof window && "undefined" != typeof document, et = ["Edge", "Trident", "Firefox"], tt = 0, nt = 0; nt < et.length; nt += 1)
            ...
            modifiers: {
                    ...
                    fn: function(e) {
                        ...
                        if (i) {
                            var r = e.offsets,
                                ...
                                u = {
                                    start: lt({}, l, o[l]),
                                    end: lt({}, l, o[l] + o[c] - a[c])
                                };
                            e.offsets.popper = ct({}, a, u[i])
                        }
                        return e
                    }
                },
                offset: {
                    ...
                    fn: function(e, t) {
                        var n = t.offset,
                            ...
                            s = i.split("-")[0],
                            l = void 0;
                        return l = O(+n) ? [+n, 0] : Q(n, o, a, s), "left" === s ? (o.top += l[0], o.left -= l[1]) : "right" === s ? (o.top += l[0], o.left += l[1]) : "top" === s ? (o.left += l[0], o.top -= l[1]) : "bottom" === s && (o.left += l[0], o.top += l[1]), e.popper = o, e
                    },
                    offset: 0
                },
                preventOverflow: {
                ...
                arrow: {
                    ...
                    fn: function(e, t) {
                        ...
                        return C = Math.max(Math.min(s[u] - g, C), 0), e.arrowElement = i, e.offsets.arrow = (lt(n = {}, f, Math.round(C)), lt(n, h, ""), n), e
                    },
                    element: "[x-arrow]"
                },
                flip: {
                    ...
                    fn: function(e, t) {
                        ...
                        return a.forEach(function(s, l) {
                            ...
                            (h || y || _) && (e.flipped = !0, (h || y) && (i = a[l + 1]), _ && (o = "end" === (c = o) ? "start" : "start" === c ? "end" : c), e.placement = i + (o ? "-" + o : ""), e.offsets.popper = ct({}, e.offsets.popper, x(e.instance.popper, e.offsets.reference, e.placement)), e = j(e.instance.modifiers, e, "flip"))
                        }), e
                    },
                    behavior: "flip",
                    padding: 5,
                ...
                inner: {
                    ...
                    fn: function(e) {
                        ...
                        return r[a ? "left" : "top"] = o[n] - (s ? r[a ? "width" : "height"] : 0), e.placement = T(t), e.offsets.popper = m(r), e
                    }
                },
                hide: {
                    order: 800,
                ...
                applyStyle: {
                    ...
                    onLoad: function(e, t, n, i, r) {
                        var o = w(r, t, e, n.positionFixed),
                            a = C(n.placement, o, t, e, n.modifiers.flip.boundariesElement, n.modifiers.flip.padding);
                ...
                value: function() {
                    return function() {
                        if (!this.state.isDestroyed) {
                            ...
                            e.offsets.reference = w(this.state, this.popper, this.reference, this.options.positionFixed), e.placement = C(this.options.placement, e.offsets.reference, this.popper, this.reference, this.options.modifiers.flip.boundariesElement, this.options.modifiers.flip.padding), e.originalPlacement = e.placement, e.positionFixed = this.options.positionFixed, e.offsets.popper = x(this.popper, e.offsets.reference, e.placement), e.offsets.popper.position = this.options.positionFixed ? "fixed" : "absolute", e = j(this.modifiers, e), this.state.isCreated ? this.options.onUpdate(e) : (this.state.isCreated = !0, this.options.onCreate(e))
                        }
                    }.call(this)
                }
            }, {
    ...
    pt.Utils = ("undefined" != typeof window ? window : global).PopperUtils, pt.placements = ut, pt.Defaults = ht;
    var gt, mt, vt, yt, bt, _t, Ct, wt, Et, Tt, xt, kt, jt, St, At, Dt, Nt, It, Ot, Lt, Ht, Pt, Qt, Mt, Rt, Ft, Wt, qt, Bt, Ut, Vt, $t, Yt, Kt, zt, Gt, Xt, Jt, Zt, en, tn, nn, rn, on, an, sn, ln, cn, un, dn, fn, hn, pn, gn, mn, vn, yn, bn, _n, Cn, wn, En, Tn, xn, kn, jn, Sn, An, Dn, Nn, In, On, Ln, Hn, Pn, Qn, Mn, Rn, Fn, Wn, qn, Bn, Un, Vn, $n, Yn, Kn, zn, Gn, Xn, Jn, Zn, ei, ti, ni, ii, ri, oi, ai, si, li, ci, ui, di, fi, hi, pi, gi, mi, vi, yi, bi, _i, Ci = (mt = "dropdown", yt = "." + (vt = "bs.dropdown"), bt = ".data-api", _t = (gt = t).fn[mt], Ct = new RegExp("38|40|27"), wt = {
            HIDE: "hide" + yt,
            HIDDEN: "hidden" + yt,
            SHOW: "show" + yt,
            SHOWN: "shown" + yt,
        ...
        }, Et = "disabled", Tt = "show", xt = "dropup", kt = "dropright", jt = "dropleft", St = "dropdown-menu-right", At = "position-static", Dt = '[data-toggle="dropdown"]', Nt = ".dropdown form", It = ".dropdown-menu", Ot = ".navbar-nav", Lt = ".dropdown-menu .dropdown-item:not(.disabled):not(:disabled)", Ht = "top-start", Pt = "top-end", Qt = "bottom-start", Mt = "bottom-end", Rt = "right-start", Ft = "left-start", Wt = {
            offset: 0,
            flip: !0,
            ...
            var t = e.prototype;
            return t.toggle = function() {
                if (!this._element.disabled && !gt(this._element).hasClass(Et)) {
                    var t = e._getParentFromElement(this._element),
                        n = gt(this._menu).hasClass(Tt);
                    if (e._clearMenus(), !n) {
                        var i = {
                                relatedTarget: this._element
                            },
                            r = gt.Event(wt.SHOW, i);
                        if (gt(t).trigger(r), !r.isDefaultPrevented()) {
                            if (!this._inNavbar) {
                                ...
                                var o = this._element;
                                "parent" === this._config.reference ? o = t : Ke.isElement(this._config.reference) && (o = this._config.reference, void 0 !== this._config.reference.jquery && (o = this._config.reference[0])), "scrollParent" !== this._config.boundary && gt(t).addClass(At), this._popper = new pt(o, this._menu, this._getPopperConfig())
                            }
                            "ontouchstart" in document.documentElement && 0 === gt(t).closest(Ot).length && gt(document.body).children().on("mouseover", null, gt.noop), this._element.focus(), this._element.setAttribute("aria-expanded", !0), gt(this._menu).toggleClass(Tt), gt(t).toggleClass(Tt).trigger(gt.Event(wt.SHOWN, i))
                        }
                    }
                }
            }, t.dispose = function() {
                gt.removeData(this._element, vt), gt(this._element).off(yt), this._element = null, (this._menu = null) !== this._popper && (this._popper.destroy(), this._popper = null)
            }, t.update = function() {
                this._inNavbar = this._detectNavbar(), null !== this._popper && this._popper.scheduleUpdate()
            }, t._addEventListeners = function() {
                var e = this;
                gt(this._element).on(wt.CLICK, function(t) {
                    t.preventDefault(), t.stopPropagation(), e.toggle()
                })
            }, t._getConfig = function(e) {
                return e = r({}, this.constructor.Default, gt(this._element).data(), e), Ke.typeCheckConfig(mt, e, this.constructor.DefaultType), e
                ...
                var e = gt(this._element).parent(),
                    t = Qt;
                return e.hasClass("dropup") ? (t = Ht, gt(this._menu).hasClass(St) && (t = Pt)) : e.hasClass(kt) ? t = Rt : e.hasClass(jt) ? t = Ft : gt(this._menu).hasClass(St) && (t = Mt), t
                ...
                return this.each(function() {
                    var n = gt(this).data(vt);
                    if (n || (n = new e(this, "object" == typeof t ? t : null), gt(this).data(vt, n)), "string" == typeof t) {
                ...
                if (!t || 3 !== t.which && ("keyup" !== t.type || 9 === t.which))
                    for (var n = gt.makeArray(gt(Dt)), i = 0; i < n.length; i++) {
                        ...
                        if (o) {
                            var s = o._menu;
                            if (gt(r).hasClass(Tt) && !(t && ("click" === t.type && /input|textarea/i.test(t.target.tagName) || "keyup" === t.type && 9 === t.which) && gt.contains(r, t.target))) {
                                var l = gt.Event(wt.HIDE, a);
                                gt(r).trigger(l), l.isDefaultPrevented() || ("ontouchstart" in document.documentElement && gt(document.body).children().off("mouseover", null, gt.noop), n[i].setAttribute("aria-expanded", "false"), gt(s).removeClass(Tt), gt(r).removeClass(Tt).trigger(gt.Event(wt.HIDDEN, a)))
                            }
                        }
                    }
            }, e._getParentFromElement = function(e) {
                var t, n = Ke.getSelectorFromElement(e);
                return n && (t = gt(n)[0]), t || e.parentNode
            }, e._dataApiKeydownHandler = function(t) {
                if ((/input|textarea/i.test(t.target.tagName) ? !(32 === t.which || 27 !== t.which && (40 !== t.which && 38 !== t.which || gt(t.target).closest(It).length)) : Ct.test(t.which)) && (t.preventDefault(), t.stopPropagation(), !this.disabled && !gt(this).hasClass(Et))) {
                    var n = e._getParentFromElement(this),
                        i = gt(n).hasClass(Tt);
                    if ((i || 27 === t.which && 32 === t.which) && (!i || 27 !== t.which && 32 !== t.which)) {
                        var r = gt(n).find(Lt).get();
                        if (0 !== r.length) {
        ...
        }(), gt(document).on(wt.KEYDOWN_DATA_API, Dt, Bt._dataApiKeydownHandler).on(wt.KEYDOWN_DATA_API, It, Bt._dataApiKeydownHandler).on(wt.CLICK_DATA_API + " " + wt.KEYUP_DATA_API, Bt._clearMenus).on(wt.CLICK_DATA_API, Dt, function(e) {
            e.preventDefault(), e.stopPropagation(), Bt._jQueryInterface.call(gt(this), "toggle")
        }).on(wt.CLICK_DATA_API, Nt, function(e) {
            e.stopPropagation()
        }), gt.fn[mt] = Bt._jQueryInterface, gt.fn[mt].Constructor = Bt, gt.fn[mt].noConflict = function() {
            return gt.fn[mt] = _t, Bt._jQueryInterface
        }, Bt),
        wi = (Vt = "modal", Yt = "." + ($t = "bs.modal"), Kt = (Ut = t).fn[Vt], zt = {
            backdrop: !0,
            keyboard: !0,
            focus: !0,
            show: !0
            ...
            function e(e, t) {
                this._config = this._getConfig(t), this._element = e, this._dialog = Ut(e).find(rn.DIALOG)[0], this._backdrop = null, this._isShown = !1, this._isBodyOverflowing = !1, this._ignoreBackdropClick = !1, this._scrollbarWidth = 0
            }
            var t = e.prototype;
            return t.toggle = function(e) {
                ...
                if (!this._isTransitioning && !this._isShown) {
                    Ut(this._element).hasClass(tn) && (this._isTransitioning = !0);
                    var n = Ut.Event(Xt.SHOW, {
                        relatedTarget: e
                    });
                    Ut(this._element).trigger(n), this._isShown || n.isDefaultPrevented() || (this._isShown = !0, this._checkScrollbar(), this._setScrollbar(), this._adjustDialog(), Ut(document.body).addClass(en), this._setEscapeEvent(), this._setResizeEvent(), Ut(this._element).on(Xt.CLICK_DISMISS, rn.DATA_DISMISS, function(e) {
                        return t.hide(e)
                    }), Ut(this._dialog).on(Xt.MOUSEDOWN_DISMISS, function() {
                        Ut(t._element).one(Xt.MOUSEUP_DISMISS, function(e) {
                ...
                if (e && e.preventDefault(), !this._isTransitioning && this._isShown) {
                    var n = Ut.Event(Xt.HIDE);
                    if (Ut(this._element).trigger(n), this._isShown && !n.isDefaultPrevented()) {
                        this._isShown = !1;
                        var i = Ut(this._element).hasClass(tn);
                        if (i && (this._isTransitioning = !0), this._setEscapeEvent(), this._setResizeEvent(), Ut(document).off(Xt.FOCUSIN), Ut(this._element).removeClass(nn), Ut(this._element).off(Xt.CLICK_DISMISS), Ut(this._dialog).off(Xt.MOUSEDOWN_DISMISS), i) {
                            var r = Ke.getTransitionDurationFromElement(this._element);
                            Ut(this._element).one(Ke.TRANSITION_END, function(e) {
                ...
                Ut.removeData(this._element, $t), Ut(window, document, this._element, this._backdrop).off(Yt), this._config = null, this._element = null, this._dialog = null, this._backdrop = null, this._isShown = null, this._isBodyOverflowing = null, this._ignoreBackdropClick = null, this._scrollbarWidth = null
            }, t.handleUpdate = function() {
                this._adjustDialog()
            }, t._getConfig = function(e) {
                return e = r({}, zt, e), Ke.typeCheckConfig(Vt, e, Gt), e
            }, t._showElement = function(e) {
                var t = this,
                    n = Ut(this._element).hasClass(tn);
                this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE || document.body.appendChild(this._element), this._element.style.display = "block", this._element.removeAttribute("aria-hidden"), this._element.scrollTop = 0, n && Ke.reflow(this._element), Ut(this._element).addClass(nn), this._config.focus && this._enforceFocus();
                var i = Ut.Event(Xt.SHOWN, {
                        relatedTarget: e
                    }),
                    r = function() {
                ...
                if (n) {
                    ...
                    Ut(this._dialog).one(Ke.TRANSITION_END, r).emulateTransitionEnd(o)
                } else r()
            }, t._enforceFocus = function() {
                var e = this;
                Ut(document).off(Xt.FOCUSIN).on(Xt.FOCUSIN, function(t) {
                    document !== t.target && e._element !== t.target && 0 === Ut(e._element).has(t.target).length && e._element.focus()
                })
            }, t._setEscapeEvent = function() {
                var e = this;
                this._isShown && this._config.keyboard ? Ut(this._element).on(Xt.KEYDOWN_DISMISS, function(t) {
                    27 === t.which && (t.preventDefault(), e.hide())
                }) : this._isShown || Ut(this._element).off(Xt.KEYDOWN_DISMISS)
            }, t._setResizeEvent = function() {
                var e = this;
                this._isShown ? Ut(window).on(Xt.RESIZE, function(t) {
                    return e.handleUpdate(t)
                }) : Ut(window).off(Xt.RESIZE)
            }, t._hideModal = function() {
                var e = this;
                this._element.style.display = "none", this._element.setAttribute("aria-hidden", !0), this._isTransitioning = !1, this._showBackdrop(function() {
                    Ut(document.body).removeClass(en), e._resetAdjustments(), e._resetScrollbar(), Ut(e._element).trigger(Xt.HIDDEN)
                })
            }, t._removeBackdrop = function() {
                this._backdrop && (Ut(this._backdrop).remove(), this._backdrop = null)
            }, t._showBackdrop = function(e) {
                var t = this,
                    n = Ut(this._element).hasClass(tn) ? tn : "";
                if (this._isShown && this._config.backdrop) {
                    if (this._backdrop = document.createElement("div"), this._backdrop.className = Zt, n && Ut(this._backdrop).addClass(n), Ut(this._backdrop).appendTo(document.body), Ut(this._element).on(Xt.CLICK_DISMISS, function(e) {
                            t._ignoreBackdropClick ? t._ignoreBackdropClick = !1 : e.target === e.currentTarget && ("static" === t._config.backdrop ? t._element.focus() : t.hide())
                        }), n && Ke.reflow(this._backdrop), Ut(this._backdrop).addClass(nn), !e) return;
                    if (!n) return void e();
                    var i = Ke.getTransitionDurationFromElement(this._backdrop);
                    Ut(this._backdrop).one(Ke.TRANSITION_END, e).emulateTransitionEnd(i)
                } else if (!this._isShown && this._backdrop) {
                    Ut(this._backdrop).removeClass(nn);
                    var r = function() {
                        t._removeBackdrop(), e && e()
                    };
                    if (Ut(this._element).hasClass(tn)) {
                        var o = Ke.getTransitionDurationFromElement(this._backdrop);
                        Ut(this._backdrop).one(Ke.TRANSITION_END, r).emulateTransitionEnd(o)
                    } else r()
                } else e && e()
                ...
                if (this._isBodyOverflowing) {
                    Ut(rn.FIXED_CONTENT).each(function(t, n) {
                        var i = Ut(n)[0].style.paddingRight,
                            r = Ut(n).css("padding-right");
                        Ut(n).data("padding-right", i).css("padding-right", parseFloat(r) + e._scrollbarWidth + "px")
                    }), Ut(rn.STICKY_CONTENT).each(function(t, n) {
                        var i = Ut(n)[0].style.marginRight,
                            r = Ut(n).css("margin-right");
                        Ut(n).data("margin-right", i).css("margin-right", parseFloat(r) - e._scrollbarWidth + "px")
                    }), Ut(rn.NAVBAR_TOGGLER).each(function(t, n) {
                        var i = Ut(n)[0].style.marginRight,
                            r = Ut(n).css("margin-right");
                        Ut(n).data("margin-right", i).css("margin-right", parseFloat(r) + e._scrollbarWidth + "px")
                    });
                    var t = document.body.style.paddingRight,
                        n = Ut(document.body).css("padding-right");
                    Ut(document.body).data("padding-right", t).css("padding-right", parseFloat(n) + this._scrollbarWidth + "px")
                }
            }, t._resetScrollbar = function() {
                Ut(rn.FIXED_CONTENT).each(function(e, t) {
                    var n = Ut(t).data("padding-right");
                    void 0 !== n && Ut(t).css("padding-right", n).removeData("padding-right")
                }), Ut(rn.STICKY_CONTENT + ", " + rn.NAVBAR_TOGGLER).each(function(e, t) {
                    var n = Ut(t).data("margin-right");
                    void 0 !== n && Ut(t).css("margin-right", n).removeData("margin-right")
                });
                var e = Ut(document.body).data("padding-right");
                void 0 !== e && Ut(document.body).css("padding-right", e).removeData("padding-right")
                ...
                return this.each(function() {
                    var i = Ut(this).data($t),
                        o = r({}, e.Default, Ut(this).data(), "object" == typeof t && t);
                    if (i || (i = new e(this, o), Ut(this).data($t, i)), "string" == typeof t) {
                        if (void 0 === i[t]) throw new TypeError('No method named "' + t + '"');
                        i[t](n)
        ...
        }(), Ut(document).on(Xt.CLICK_DATA_API, rn.DATA_TOGGLE, function(e) {
            var t, n = this,
                i = Ke.getSelectorFromElement(this);
            i && (t = Ut(i)[0]);
            var o = Ut(t).data($t) ? "toggle" : r({}, Ut(t).data(), Ut(this).data());
            "A" !== this.tagName && "AREA" !== this.tagName || e.preventDefault();
            var a = Ut(t).one(Xt.SHOW, function(e) {
                e.isDefaultPrevented() || a.one(Xt.HIDDEN, function() {
                    Ut(n).is(":visible") && n.focus()
                })
            });
            on._jQueryInterface.call(Ut(t), o, this)
        }), Ut.fn[Vt] = on._jQueryInterface, Ut.fn[Vt].Constructor = on, Ut.fn[Vt].noConflict = function() {
            return Ut.fn[Vt] = Kt, on._jQueryInterface
        }, on),
        Ei = (sn = "tooltip", cn = "." + (ln = "bs.tooltip"), un = (an = t).fn[sn], dn = "bs-tooltip", fn = new RegExp("(^|\\s)" + dn + "\\S+", "g"), gn = {
            animation: !0,
        ...
        }, bn = "fade", _n = "show", Cn = ".tooltip-inner", wn = ".arrow", En = "hover", Tn = "focus", xn = "click", kn = "manual", jn = function() {
            function e(e, t) {
            ...
            return t.enable = function() {
                ...
                if (this._isEnabled)
                    if (e) {
                        ...
                        if (an(this.getTipElement()).hasClass(_n)) return void this._leave(null, this);
                ...
                if (this.isWithContent() && this._isEnabled) {
                    ...
                    var s = !1 === this.config.container ? document.body : an(this.config.container);
                    an(i).data(this.constructor.DATA_KEY, this), an.contains(this.element.ownerDocument.documentElement, this.tip) || an(i).appendTo(s), an(this.element).trigger(this.constructor.Event.INSERTED), this._popper = new pt(this.element, i, {
                        placement: a,
                        modifiers: {
                            offset: {
                    ...
                    }), an(i).addClass(_n), "ontouchstart" in document.documentElement && an(document.body).children().on("mouseover", null, an.noop);
                    var l = function() {
                    ...
                    if (an(this.tip).hasClass(bn)) {
                        ...
                        an(this.tip).one(Ke.TRANSITION_END, l).emulateTransitionEnd(c)
                    } else l()
                }
            }, t.hide = function(e) {
                var t = this,
                    ...
                    r = function() {
                        t._hoverState !== mn && n.parentNode && n.parentNode.removeChild(n), t._cleanTipClass(), t.element.removeAttribute("aria-describedby"), an(t.element).trigger(t.constructor.Event.HIDDEN), null !== t._popper && t._popper.destroy(), e && e()
                    };
                if (an(this.element).trigger(i), !i.isDefaultPrevented()) {
                    if (an(n).removeClass(_n), "ontouchstart" in document.documentElement && an(document.body).children().off("mouseover", null, an.noop), this._activeTrigger.click = !1, this._activeTrigger[Tn] = !1, this._activeTrigger[En] = !1, an(this.tip).hasClass(bn)) {
                        var o = Ke.getTransitionDurationFromElement(n);
                        an(n).one(Ke.TRANSITION_END, r).emulateTransitionEnd(o)
                    } else r();
                    this._hoverState = ""
                }
            }, t.update = function() {
                ...
                this.setElementContent(e.find(Cn), this.getTitle()), e.removeClass(bn + " " + _n)
                ...
                this.config.trigger.split(" ").forEach(function(t) {
                    if ("click" === t) an(e.element).on(e.constructor.Event.CLICK, e.config.selector, function(t) {
                        ...
                        var n = t === En ? e.constructor.Event.MOUSEENTER : e.constructor.Event.FOCUSIN,
                            i = t === En ? e.constructor.Event.MOUSELEAVE : e.constructor.Event.FOCUSOUT;
                ...
                (t = t || an(e.currentTarget).data(n)) || (t = new this.constructor(e.currentTarget, this._getDelegateConfig()), an(e.currentTarget).data(n, t)), e && (t._activeTrigger["focusin" === e.type ? Tn : En] = !0), an(t.getTipElement()).hasClass(_n) || t._hoverState === mn ? t._hoverState = mn : (clearTimeout(t._timeout), t._hoverState = mn, t.config.delay && t.config.delay.show ? t._timeout = setTimeout(function() {
                    t._hoverState === mn && t.show()
                }, t.config.delay.show) : t.show())
            }, t._leave = function(e, t) {
                var n = this.constructor.DATA_KEY;
                (t = t || an(e.currentTarget).data(n)) || (t = new this.constructor(e.currentTarget, this._getDelegateConfig()), an(e.currentTarget).data(n, t)), e && (t._activeTrigger["focusout" === e.type ? Tn : En] = !1), t._isWithActiveTrigger() || (clearTimeout(t._timeout), t._hoverState = vn, t.config.delay && t.config.delay.hide ? t._timeout = setTimeout(function() {
                ...
                return "number" == typeof(e = r({}, this.constructor.Default, an(this.element).data(), e)).delay && (e.delay = {
                    show: e.delay,
                    hide: e.delay
                }), "number" == typeof e.title && (e.title = e.title.toString()), "number" == typeof e.content && (e.content = e.content.toString()), Ke.typeCheckConfig(sn, e, this.constructor.DefaultType), e
                ...
                return this.each(function() {
                    var n = an(this).data(ln),
                        i = "object" == typeof t && t;
                    if ((n || !/dispose|hide/.test(t)) && (n || (n = new e(this, i), an(this).data(ln, n)), "string" == typeof t)) {
                        if (void 0 === n[t]) throw new TypeError('No method named "' + t + '"');
                        n[t]()
                    }
                })
        ...
        }(), an.fn[sn] = jn._jQueryInterface, an.fn[sn].Constructor = jn, an.fn[sn].noConflict = function() {
            return an.fn[sn] = un, jn._jQueryInterface
        }, jn),
        Ti = (An = "popover", Nn = "." + (Dn = "bs.popover"), In = (Sn = t).fn[An], On = "bs-popover", Ln = new RegExp("(^|\\s)" + On + "\\S+", "g"), Hn = r({}, Ei.Default, {
            placement: "right",
            trigger: "click",
            content: "",
        ...
        }), Qn = "fade", Rn = ".popover-header", Fn = ".popover-body", Wn = {
            HIDE: "hide" + Nn,
            HIDDEN: "hidden" + Nn,
            SHOW: (Mn = "show") + Nn,
            SHOWN: "shown" + Nn,
            ...
            return o.isWithContent = function() {
                ...
                Sn(this.getTipElement()).addClass(On + "-" + e)
                ...
                return this.each(function() {
                    var n = Sn(this).data(Dn),
                        i = "object" == typeof e ? e : null;
                    if ((n || !/destroy|hide/.test(e)) && (n || (n = new t(this, i), Sn(this).data(Dn, n)), "string" == typeof e)) {
        ...
        }(Ei), Sn.fn[An] = qn._jQueryInterface, Sn.fn[An].Constructor = qn, Sn.fn[An].noConflict = function() {
            return Sn.fn[An] = In, qn._jQueryInterface
        }, qn),
        xi = (Un = "scrollspy", $n = "." + (Vn = "bs.scrollspy"), Yn = (Bn = t).fn[Un], Kn = {
            offset: 10,
            method: "auto",
            target: ""
        }, zn = {
            ...
            return t.refresh = function() {
                ...
                this._offsets = [], this._targets = [], this._scrollHeight = this._getScrollHeight(), Bn.makeArray(Bn(this._selector)).map(function(e) {
                    var t, r = Ke.getSelectorFromElement(e);
                    if (r && (t = Bn(r)[0]), t) {
                        var o = t.getBoundingClientRect();
                        if (o.width || o.height) return [Bn(t)[n]().top + i, r]
                    }
                    return null
                }).filter(function(e) {
                    return e
                ...
                Bn.removeData(this._element, Vn), Bn(this._scrollElement).off($n), this._element = null, this._scrollElement = null, this._config = null, this._selector = null, this._offsets = null, this._targets = null, this._activeTarget = null, this._scrollHeight = null
            }, t._getConfig = function(e) {
                if ("string" != typeof(e = r({}, Kn, e)).target) {
                    var t = Bn(e.target).attr("id");
                    t || (t = Ke.getUID(Un), Bn(e.target).attr("id", t)), e.target = "#" + t
                }
                return Ke.typeCheckConfig(Un, e, zn), e
                ...
                var n = Bn(t.join(","));
                n.hasClass(Xn) ? (n.closest(Zn.DROPDOWN).find(Zn.DROPDOWN_TOGGLE).addClass(Jn), n.addClass(Jn)) : (n.addClass(Jn), n.parents(Zn.NAV_LIST_GROUP).prev(Zn.NAV_LINKS + ", " + Zn.LIST_ITEMS).addClass(Jn), n.parents(Zn.NAV_LIST_GROUP).prev(Zn.NAV_ITEMS).children(Zn.NAV_LINKS).addClass(Jn)), Bn(this._scrollElement).trigger(Gn.ACTIVATE, {
                    relatedTarget: e
                })
            }, t._clear = function() {
                ...
                return this.each(function() {
                    ...
                    if (n || (n = new e(this, "object" == typeof t && t), Bn(this).data(Vn, n)), "string" == typeof t) {
                        if (void 0 === n[t]) throw new TypeError('No method named "' + t + '"');
                        n[t]()
                    }
                })
        ...
        }(), Bn(window).on(Gn.LOAD_DATA_API, function() {
            for (var e = Bn.makeArray(Bn(Zn.DATA_SPY)), t = e.length; t--;) {
                var n = Bn(e[t]);
                ni._jQueryInterface.call(n, n.data())
            }
        }), Bn.fn[Un] = ni._jQueryInterface, Bn.fn[Un].Constructor = ni, Bn.fn[Un].noConflict = function() {
            return Bn.fn[Un] = Yn, ni._jQueryInterface
        }, ni),
        ki = (oi = "." + (ri = "bs.tab"), ai = (ii = t).fn.tab, si = {
            HIDE: "hide" + oi,
            HIDDEN: "hidden" + oi,
            SHOW: "show" + oi,
            SHOWN: "shown" + oi,
            CLICK_DATA_API: "click" + oi + ".data-api"
        }, li = "dropdown-menu", ci = "active", ui = "disabled", di = "fade", fi = "show", hi = ".dropdown", pi = ".nav, .list-group", gi = ".active", mi = "> li > .active", vi = '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', yi = ".dropdown-toggle", bi = "> .dropdown-menu .active", _i = function() {
            function e(e) {
                this._element = e
            }
            var t = e.prototype;
            return t.show = function() {
                ...
                if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && ii(this._element).hasClass(ci) || ii(this._element).hasClass(ui))) {
                    ...
                    if (i) {
                        var o = "UL" === i.nodeName ? mi : gi;
                        n = (n = ii.makeArray(ii(i).find(o)))[n.length - 1]
                    }
                    var a = ii.Event(si.HIDE, {
                            relatedTarget: this._element
                        }),
                        s = ii.Event(si.SHOW, {
                            relatedTarget: n
                        });
                    if (n && ii(n).trigger(a), ii(this._element).trigger(s), !s.isDefaultPrevented() && !a.isDefaultPrevented()) {
                        r && (t = ii(r)[0]), this._activate(this._element, i);
                        var l = function() {
                            var t = ii.Event(si.HIDDEN, {
                ...
                var i = this,
                    r = ("UL" === t.nodeName ? ii(t).find(mi) : ii(t).children(gi))[0],
                ...
                if (r && o) {
                    ...
                    ii(r).one(Ke.TRANSITION_END, a).emulateTransitionEnd(s)
                } else a()
            }, t._transitionComplete = function(e, t, n) {
                if (t) {
                    ii(t).removeClass(fi + " " + ci);
                    var i = ii(t.parentNode).find(bi)[0];
                    i && ii(i).removeClass(ci), "tab" === t.getAttribute("role") && t.setAttribute("aria-selected", !1)
                }
                if (ii(e).addClass(ci), "tab" === e.getAttribute("role") && e.setAttribute("aria-selected", !0), Ke.reflow(e), ii(e).addClass(fi), e.parentNode && ii(e.parentNode).hasClass(li)) {
            ...
            return ii.fn.tab = ai, _i._jQueryInterface
        }, _i);
    ! function(e) {
        if (void 0 === e) throw new TypeError("Bootstrap's JavaScript requires jQuery. jQuery must be included before Bootstrap's JavaScript.");
        var t = e.fn.jquery.split(" ")[0].split(".");
        if (t[0] < 2 && t[1] < 9 || 1 === t[0] && 9 === t[1] && t[2] < 1 || 4 <= t[0]) throw new Error("Bootstrap's JavaScript requires at least jQuery v1.9.1 but less than v4.0.0")
    }(t), e.Util = Ke, e.Alert = ze, e.Button = Ge, e.Carousel = Xe, e.Collapse = Je, e.Dropdown = Ci, e.Modal = wi, e.Popover = Ti, e.Scrollspy = xi, e.Tab = ki, e.Tooltip = Ei, Object.defineProperty(e, "__esModule", {
        value: !0
    })
}),
function(e) {
...
var Codebase = function() {
        ...
        M = function() {
            jQuery(".js-table-sections:not(.js-table-sections-enabled)").each(function() {
                ...
                e.addClass("js-table-sections-enabled"), jQuery(".js-table-sections-header > tr", e).on("click.cb.helpers", function(t) {
                    if (!("checkbox" === t.target.type || "button" === t.target.type || "a" === t.target.tagName.toLowerCase() || jQuery(t.target).parent("a").length || jQuery(t.target).parent("button").length || jQuery(t.target).parent(".custom-control").length || jQuery(t.target).parent("label").length)) {
    ...
    return {
        init: function() {
            p(), g("init"), m(), v(), y(), b(), _(), w("init"), E(!1, "init"), x(), k(), j(), S(), A(), D(), N(), I(), O(), L("hide"), H(), P()
        },
        layout: function(e) {
            w(e)
        },
