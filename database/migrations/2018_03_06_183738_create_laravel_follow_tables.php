    ...
    */
    public function up()
    {
        Schema::create(config('follow.followable_table', 'followables'), function (Blueprint $table) {
            ...
            4 Member: Some Profiles are organizations, and members are selected by the organization (not the other way around)
            5 Follower: Free to use for any profile, useful if you want to receive feeds from the company regarding updates.
            ');
